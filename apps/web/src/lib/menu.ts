...
import { HQ_TEMPLATE_DISTRIBUTION_ENABLED } from './hq-template-availability'
...
export const HQ_MENU_SECTIONS: MenuSection[] = [
  {
    ...
    items: [
      ...
      { href: HQ_TEMPLATE_DISTRIBUTION_ENABLED ? '/hq/templates?type=tag' : hqOpenHref('tags'), label: 'タグ', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', id: 'hq-tags', note: HQ_TEMPLATE_DISTRIBUTION_ENABLED ? 'タグのひな形と店舗への配布を管理します' : '店舗を選んでタグ管理を開きます', required: true },
