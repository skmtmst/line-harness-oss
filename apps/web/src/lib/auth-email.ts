...
export const PUBLIC_AUTH_PATHS = ['/login', '/login/two-factor', '/staff/invite', '/register', '/register/sent', '/register/complete', '/password/forgot', '/password/reset', '/ops/login', '/ops/invite'] as const
