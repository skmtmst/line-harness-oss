...
export const api = {
  ...
  templates: {
    ...
    create: (data: {
      ...
      fetchApi<ApiResponse<{ id: string; name: string; category: string; messageType: string; messageContent: string; folderId: string | null; isFavorite: boolean; question: TemplateQuestion | null; questionStatus: 'draft' | 'published'; createdAt: string; updatedAt: string }>>(
        '/api/templates',
        { method: 'POST', body: JSON.stringify(data) },
      ),
    update: (
