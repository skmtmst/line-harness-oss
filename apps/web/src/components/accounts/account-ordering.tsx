...
export default function AccountOrdering() {
  ...
  return <section className="mt-6 border-t border-hairline pt-6" aria-labelledby="account-ordering-title">
    ...
    <div className="mb-4 rounded-control border border-info bg-info-bg px-4 py-3 text-xs font-medium text-info">⚓ 登録済みのLINEアカウントをドラッグ＆ドロップし、親・子・孫の3階層まで紐付けます。下位階層を表示・操作できるのは「他アカウント権限」がONの管理者だけです。</div>
