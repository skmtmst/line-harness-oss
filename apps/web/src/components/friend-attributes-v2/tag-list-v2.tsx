...
export default function FriendAttributesV2TagList({ fixture }: { fixture?: FriendAttributesV2Fixture }) {
  ...
  return <div data-design-node="xn98K" className="min-w-0 text-[#1d1d1f] [font-family:'SF_Pro_Text',-apple-system,BlinkMacSystemFont,'Helvetica_Neue',Arial,sans-serif]">
