    ...
    <div data-design-node="uJP22" data-design="Body" className={styles.screen}>
      ...
      <ReminderWorkspace aside={<div data-design="Right">
        ...
        <ReminderPanel title="基準日の選択" note="予約日時・友だち情報欄の日付・フォーム回答日から選べます。">
          ...
          {triggerType === 'event' ? (
            <div className="mt-3">
              <Field label="基準日にするイベント" required note="このイベントの予約日時を起点にします">
                <div className="flex items-center gap-2">
                  <SelectField
