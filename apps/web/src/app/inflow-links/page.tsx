    ...
    <div>
      ...
      <div className="grid gap-5 2xl:grid-cols-[280px_minmax(0,1fr)]">
        <aside>
          <button
            onClick={() => setEditingGenre('new')}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-bold text-on-accent shadow-sm hover:bg-accent-hover"
          >
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/45 p-4">
      <div className="w-full max-w-md rounded-2xl bg-canvas p-6 shadow-2xl">
        ...
        <div className="mt-5 text-center">
          ...
          <a href={downloadUrl} download={`referral-${route.refCode}.png`} className="mt-4 inline-flex w-full items-center justify-center rounded-lg bg-accent px-4 py-2.5 text-sm font-semibold text-on-accent hover:bg-accent-hover">
            QRコードをダウンロード
          </a>
        </div>
      </div>
