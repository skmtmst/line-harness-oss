...
describe('V6 LINE通知（festr）', () => {
  it('送れなかった帯から、対応一覧へ渡す', () => {
    ...
    */
    const failed = customerNotificationKpis({
      ready: true, settingsCount: 4, enabledCount: 3, sentToday: 20, sentBreakdown: '注文 12・発送 8', failed: 2,
  ...
  it('数えていないものを0で埋めない', () => {
    const unavailable = customerNotificationKpis({
      ready: false, settingsCount: 0, enabledCount: 0, sentToday: null, sentBreakdown: '', failed: null,
    })
