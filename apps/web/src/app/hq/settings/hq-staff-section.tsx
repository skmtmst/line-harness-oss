...
export default function HqStaffSection() {
  ...
  const saveScope = async () => {
    ...
    const response = await api.staff.update(editing.id, { accountScope: editing.accountScope ?? 'all', scopedLineAccountIds: editing.scopedLineAccountIds, managementContext: 'hq' })
