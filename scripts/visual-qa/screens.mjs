...
export const SCREENS = [
  ...
  */
  ...
  },
  {
    ...
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #290・`de8b7c75b` を1440/1920px撮影し、同Nodeの設計本文と文字照合。** 対象名、削除後の共通案内、履歴保持、取消不可、取消／削除操作、背面一覧のページ送りがそろい、横はみ出し0。Issue #474でPencil HTMLから設計PNGを再描画し、設計は小型の削除確認、実装は説明領域を広くした共通確認ダイアログで同じ対象・影響・取消／削除を表示するため残差14.2753%。',
  ...
  */
  ...
  },
  {
    ...
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #289 / UI HEAD a571acc25 / 固定データ PR #1060（統合 #1067）で最終一致。** 旧機能説明会、申込85人、視聴99人、公開URL無効化、履歴保持、復元、設定サマリー、LINEプレビュー、取消・実行を表示した。3102/8789の1440/1920pxで横はみ出し0。Issue #474でPencil HTMLから設計PNGを再描画し、設計は詳細画面上の確認、実装は一覧上の共通確認ダイアログで同じ対象・保持記録・復元を表示するため残差24.3843%。',
  ...
  */
  {
    ...
    verdictSource: 'settings-v6/QT91v.png（Pencil） + settings-v6/QT91v.txt + settings-v6/QT91v-{1440,1920}.png（実装） + Issue #474', verdictHead: '529b8d1825',
  },
  {
    ...
    verdictSource: 'settings-v6/b2NGxk.png（Pencil） + settings-v6/b2NGxk.txt + settings-v6/b2NGxk-{1440,1920}.png（実装） + Issue #474', verdictHead: '712903532',
  },
  {
    ...
    verdictSource: 'settings-v6/T9rA9.png（Pencil） + settings-v6/T9rA9.txt + settings-v6/T9rA9-{1440,1920}.png（実装） + Issue #474', verdictHead: '529b8d1825',
  },
  {
    ...
    verdictSource: 'settings-v6/nx3XW.png（Pencil） + settings-v6/nx3XW.txt + settings-v6/nx3XW-{1440,1920}.png（実装） + Issue #474', verdictHead: '529b8d1825',
  },
...

  {
    ...
    verdictSource: 'settings-v6/RAW35.png（Pencil） + settings-v6/RAW35.txt + settings-v6/RAW35-{1440,1920}.png（実装） + Issue #474', verdictHead: '82f3dccf7c',
  },
  {
    ...
    verdictSource: 'settings-v6/y0P0Qx.png（Pencil） + settings-v6/y0P0Qx.txt + settings-v6/y0P0Qx-{1440,1920}.png（実装） + Issue #474', verdictHead: '82f3dccf7c',
  },
  {
    ...
    verdictSource: 'settings-v6/D5UaX.png（Pencil） + settings-v6/D5UaX.txt + settings-v6/D5UaX-{1440,1920}.png（実装） + Issue #474', verdictHead: '82f3dccf7c',
  },
  {
    ...
    verdictSource: 'settings-v6/f9oUm.png（Pencil） + settings-v6/f9oUm.txt + settings-v6/f9oUm-{1440,1920}.png（実装） + Issue #474', verdictHead: '82f3dccf7c',
  },
]
