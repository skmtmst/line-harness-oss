...
export const SCREENS = [
  ...
  */
  ...
  { ...MILEAGE, node: 'N46cQ', name: '17-1-A たまる決めごと', route: '/mileage?tab=earning-rules',
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** 9件を全表示して各行が3段になっていたため設計より260px長かった。公開版確認を2段目へ収め、設計どおり1ページ8件とページ送りに変更。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差0px、画素差5.8712%。',
  ...
  },
  {
    ...
    */
    ...
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** 履歴の理由欄を4段から2段へ整理し、発生元などの全情報はマウスを重ねると確認できるよう維持した。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差0px、画素差5.0185%。',
  ...
  },
  {
    ...
    */
    ...
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** 基本・交換後・交換対象を3列にし、交換条件は必要時に開ける形へ整理して保存機能を維持した。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差+7px、画素差6.4103%。',
  ...
  },
  {
    ...
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #482 / UI HEAD 2559631b1 で通常状態を再判定。** N46cQと同じ一覧の9件全表示・3段構成を、1ページ8件・2段構成へ変更した。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差0px、画素差4.5516%。読込中・0件・取得失敗の状態契約も維持。",
  ...
  */
  ...
  { ...INFLOW, node: 'IhSBB', name: '18-1-A サイトスクリプト', route: '/inflow-links?tab=script',
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** #1287の設計高を初期viewportにする規約で撮り直し、主欄＋右欄、貼るコード、受信確認、ドメイン情報を同時に表示できることを確認。3105/8792の1440・1920pxとも横はみ出し0、高さ差0px、画素差4.8042%。",
  ...
  { ...INFLOW, node: 'TEVk8', name: '18-1-C 流入リンクをつくる', route: '/inflow-links/new',
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** 追加時の3つの動きを横並びにし、転送・期限・公開の補助設定を必要時に開く構成へ整理した。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差+8px、画素差5.2284%。",
  ...
  */
  { ...INFLOW, node: 'BuVDB', name: '18-2 広告とのつなぎ（成果の対応付け）', route: '/inflow-links?tab=connections',
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #482 / UI HEAD 2559631b1 で再判定。** 誤って広告指標タブを撮っていた機能18専用経路を成果対応付けタブへ修正し、対応表を主欄、しくみと注意を右欄へ配置した。3105/8792で1440・1920pxを撮り直し、横はみ出し0、高さ差0px、画素差4.6025%。",
