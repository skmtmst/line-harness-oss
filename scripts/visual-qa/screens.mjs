...
export const SCREENS = [
  ...
  },
  {
    ...
    steps: [{ click: 'QRを表示' }],
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #484、UI HEAD `095f843fc` で再計測し、画素差5.5290%へ改善。** QR確認窓のヒントを右列へ収め、背景の暗さをPencil V6へ揃えた。高さ差0px、1440/1920px・横はみ出し0で一致を維持。",
  ...
  */
  ...
  },
  {
    ...
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #484、UI HEAD `095f843fc` で再計測し、画素差4.1077%へ改善。** 背面をPencil V6と同じ全タグ一覧・固定行順にし、アフィリエイト警告を専用欄だけへ整理して確認窓の暗さと位置を揃えた。高さ差0px、1440/1920px・横はみ出し0で一致。",
  ...
  },
  {
    ...
    steps: [{ wait: 1500 }],
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #484、UI HEAD `095f843fc` で再計測し、画素差4.2051%へ改善。** 実画面の遡及確認を設計と同じ上端状態で直接開き、確認表・取消不能警告・確認チェックの寸法と文言を揃えた。高さ差0px、1440/1920px・横はみ出し0で一致。",
...
export const CAPTURED_AT = {
  ...
  4: [
    { pr: 0, head: '095f843fc', on: '2026-09-07', screens: ['dKlkz', 'VjXGX'], note: 'Issue #484。列車154を取り込み、3106/8793で1440/1920pxを正式再撮影。画素差を4.1077%・4.2051%、高さ差0px、横はみ出し0へ揃えた。' },
  ...
  1: [
    { pr: 0, head: '095f843fc', on: '2026-09-07', screens: ['JN6mQ'], note: 'Issue #484。列車154を取り込み、3106/8793で1440/1920pxを正式再撮影。画素差5.5290%、高さ差0px、横はみ出し0へ揃えた。' },
