...
export const CAPTURED_AT = {
  ...
  6: [
    ...
    { pr: 674, head: '7d830282', on: '2026-09-02',
      ...
      note: '最新 development `7d830282` で撮った。第1群5本（#666 #667 #668 #670 #674）と'
        + '第2群4本（#660 #661 #664 #665）が入った木。撮影は内蔵SSDのクローン（外付けは障害のため使わない）。'
        + '`TmHjF`（一覧の状態）が今回は撮れた。'
        + '`h0kahp`・`vW4Es`・`FpgxH` は `locator.fill` が30秒で時間切れ。**placeholder（例：8月キャンペーンのお知らせ／テキストを入力）は画面に在ることを確かめた**ので、'
        + '実装が消えたのではなく **台帳の `steps` が #674 の5段の作りに追いついていない**とみられる。'
  ...
  14: [
    ...
    { pr: 668, head: '7d830282', on: '2026-09-02',
      ...
      note: '最新 development `7d830282` で撮った。第1群5本（#666 #667 #668 #670 #674）と'
        + '第2群4本（#660 #661 #664 #665）が入った木。撮影は内蔵SSDのクローン（外付けは障害のため使わない）。'
        + '`uNBlA`（変える前に影響を見る）は `locator.fill` が時間切れで撮れていない。' },
  ],
  26: [
