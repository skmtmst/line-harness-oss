...
export const SCREENS = [
  ...
  },
  {
    ...
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #464で(b)固定データ差として修正・再判定。** 選択窓の先頭4件をPencilと同じ名前・順序・選択状態にそろえ、3102/8789で1440/1920pxを再撮影。横はみ出し0。検索、フォルダ、分類、一覧、プレビュー、入力欄へ挿入する操作も維持した。",
  ...
  */
  ...
  },
  {
    ...
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #464で(b)撮影状態と共通固定データの差として再判定。** 画面固有の手順でAND条件3件を同じ位置まで入力し、3102/8789の1440/1920pxで横はみ出し0。Pencilの定期便提案対象126人に対し、共通のタグ一覧とfriends応答は別所有のためNEN会員231人を表示しており、数値を作っていない。AND、ORの11軸、表示対象、並び順、保存・実行操作は維持した。",
  ...
  */
  ...
  },
  {
    ...
    */
    ...
    verdict: 'match',
    verdictNote: '**2026-09-07 Issue #464で(a)画面固有ダイアログの差として修正・再判定。** Pencilと同じ720px幅、見出し区切り、閉じる操作、本文・下部操作の区画へそろえた。使用中3か所の削除停止と差し替え導線を保ち、3102/8789で1440/1920pxを再撮影。横はみ出し0。',
  ...
  */
  ...
  },
  {
    ...
    verdict: "match",
    verdictNote: "**2026-09-07 Issue #464で(a)画面固有ダイアログの差として修正・再判定。** 800px幅、見出しと閉じる操作、4指標、却下行を含む内訳、振込先、警告、LINE通知とPDFの2選択、下部注意と操作をPencil順へそろえた。口座番号は安全のため末尾だけを扱う。3102/8789で1440/1920pxを再撮影し、横はみ出し0。",
