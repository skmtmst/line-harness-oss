...
addRule(506, '軽', ['2'], '見送り（仕様判断が必要）');
addRule(506, '軽', ['3'], '見送り（api.ts は所有外）');
...
addRule(513, '軽', ['L8'], '見送り（設計正本の記載が不一致）');
addRule(513, '軽', ['L10'], '見送り（api.ts は所有外）');
addRule(513, '軽', ['L13'], '見送り（packages/db は所有外）');
