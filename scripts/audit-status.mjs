...
// Muse便から所有を分け、実際に担当する後続票へ付け替えた項目。
addRule(495, '軽', ['14'], '別票 #598');
addRule(494, '軽', ['15'], '別票 #598');
addRule(508, '軽', ['4'], '別票 #598');
addRule(512, '軽', ['2'], '別票 #598');

addRule(502, '軽', ['3', '4', '6'], '別票 #599');
addRule(498, '軽', ['m1', 'm3', 'm8'], '別票 #599');
addRule(519, '軽', ['9'], '別票 #599');

addRule(501, '軽', ['7'], '別票 #600');
addRule(497, '軽', ['8'], '別票 #600');
addRule(517, '軽', ['1'], '別票 #600');
addRule(509, '軽', ['2'], '別票 #600');
