...
**渡された絵が最新の正。** 実装に前からあって絵に無いものは、残す理由が
無い限り**外す**。2026-08-18 に決めた。

シナリオ編集で、5枚の札の下にシナリオの説明文が出ていた。前からあった
ものだが絵には無い。こういうものが残っていると、絵と実装のどちらが正か
判断できなくなり、次に見る人が「絵が古いのかもしれない」と迷う。

**並び順も絵に合わせる。** 同じ節が全部あっても、順番が違えば別の画面に
見える。同じシナリオ編集で、5枚の札と統計の帯が絵と逆に出ていた。

外していいか迷うものは2つだけ:

| | どうするか |
|---|---|
| 受け口が無いことの説明（「◯◯はまだ作れません」） | **残す。** 絵に無くても、押せない理由が分からないと同じ質問が繰り返される |
| 絵に出ていない状態の中身（編集フォームの入力欄など） | **残す。** 絵はその状態を描いていないだけで、無いわけではない |

それ以外の「前からあったが絵に無いもの」は外す。
