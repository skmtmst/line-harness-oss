...
| N-138 | 中 | 11 テンプレート | 差し込める項目が要件の半分 | staging済み | #681 | #1501 | 215 | 53 | consolidated §2 F11-M-07／feature-11.md／apps/web/src/app/templates/edit/page.tsx:217-246／PR #1501 Required PR gate全成功／列車215／staging53／#617 |
...
| N-141 | 軽 | 11 テンプレート | 「フォルダ」と「置き場」の二重入力 | staging済み | #681 | #1501 | 215 | 53 | consolidated §2 F11-L-02／feature-11.md／apps/web/src/app/templates/edit/page.tsx:181-198／PR #1501 Required PR gate全成功／列車215／staging53／#617 |
...
| N-148 | 軽 | 11 テンプレート | メッセージ編集の見本が{{name}}しか置き換えない | staging済み | #681 | #1501 | 215 | 53 | consolidated §2 F11-L-09／feature-11.md／apps/web/src/app/templates/edit/page.tsx:106／PR #1501 Required PR gate全成功／列車215／staging53／#617 |
...
| N-172 | 中 | 13 フォーム | 一覧の並び順・表示件数が固定 | 本流統合・検証反映済み | [#676](https://github.com/kentavndng/line-harness-board/issues/676) | [#1503](https://github.com/skmtmst/line-harness-oss/pull/1503) | 217/[#1519](https://github.com/skmtmst/line-harness-oss/pull/1519) | 54回目 | consolidated §2 F13-M-03／feature-13.md／apps/web/src/app/form-submissions/page.tsx:227,287-293／現実行124件PASS＋コード読み／確度高／#617 |
| N-173 | 中 | 13 フォーム | 「集まった回答を見る」が先頭フォーム固定で誤誘導する | 本流統合・検証反映済み | [#676](https://github.com/kentavndng/line-harness-board/issues/676) | [#1503](https://github.com/skmtmst/line-harness-oss/pull/1503) | 217/[#1519](https://github.com/skmtmst/line-harness-oss/pull/1519) | 54回目 | consolidated §2 F13-M-04／feature-13.md／apps/web/src/app/form-submissions/page.tsx:253-259／現実行124件PASS＋コード読み／確度高／#617 |
...
| N-180 | 軽 | 13 フォーム | 一覧の「更新」列が作成日を表示している | 本流統合・検証反映済み | [#676](https://github.com/kentavndng/line-harness-board/issues/676) | [#1503](https://github.com/skmtmst/line-harness-oss/pull/1503) | 217/[#1519](https://github.com/skmtmst/line-harness-oss/pull/1519) | 54回目 | consolidated §2 F13-L-01／feature-13.md／apps/web/src/app/form-submissions/page.tsx:396／現実行124件PASS＋コード読み／確度高／#617 |
| N-181 | 軽 | 13 フォーム | 初回空状態に実装事情の文言が混ざる | 本流統合・検証反映済み | [#676](https://github.com/kentavndng/line-harness-board/issues/676) | [#1503](https://github.com/skmtmst/line-harness-oss/pull/1503) | 217/[#1519](https://github.com/skmtmst/line-harness-oss/pull/1519) | 54回目 | consolidated §2 F13-L-02／feature-13.md／apps/web/src/app/form-submissions/page.tsx:339／現実行124件PASS＋コード読み／確度高／#617 |
...
| N-197 | 中 | 15 メディア | staffに編集・削除ボタンが見えるのにAPIはowner/admin限定 | staging済み | #667 | #1487 | 215 | 53 | consolidated §2 F15-M-2／feature-15.md／apps/worker/src/routes/contents.ts:678,724,751／PR #1487 Required PR gate全成功／列車215／staging53／#617 |
...
| ID | 重大度 | 機能 | 所見 | 状態 | Issue | PR | train | staging | evidence |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| N-206 | 重大 | 16 成果・アフィリエイト | 承認済み報酬が版固定されず後編集で支払額が変わる | 本流統合・検証反映済み | [#647](https://github.com/kentavndng/line-harness-board/issues/647) | [#1473](https://github.com/skmtmst/line-harness-oss/pull/1473) | 219/[#1521](https://github.com/skmtmst/line-harness-oss/pull/1521) | 56回目 | consolidated §2 F16-S-1／feature-16.md／packages/db/src/affiliate-settlements.ts:36-43／現実行268件PASS＋grep／確度高／#617 |
...
| N-320 | 中 | 23 EC連携 | 止めると影響の件数が全体件数と混在＋やり直し規定が常時非表示 | PR審査 | [#948](https://github.com/kentavndng/line-harness-board/issues/948) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 consolidated §2 F23-M-04／feature-23.md／connectorタブの影響件数確認。apps/worker/src/routes/ec-commerce.ts:400・439／92件PASS／コード読み／確度高／#617 |
...
| N-322 | 中 | 23 EC連携 | 取り込みを止めるが保存必須の2段階で止めたつもりになる | PR審査 | [#948](https://github.com/kentavndng/line-harness-board/issues/948) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 consolidated §2 F23-M-06／feature-23.md／止める押下後に保存せず離脱。apps/web/src/app/ec-commerce/connector-panel.tsx:151／92件PASS／コード読み／確度高／#617 |
...
| N-325 | 軽 | 23 EC連携 | 定期便検索のplaceholderが実検索対象とずれる | PR審査 | [#948](https://github.com/kentavndng/line-harness-board/issues/948) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 consolidated §2 F23-L-03／feature-23.md／placeholderと対象比較。apps/web/src/app/ec-commerce/subscriptions-panel.tsx:88・57-62／92件PASS／コード読み／確度高／#617 |
| N-326 | 軽 | 23 EC連携 | 保存ボタンが押せない理由が分からない | PR審査 | [#948](https://github.com/kentavndng/line-harness-board/issues/948) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 consolidated §2 F23-L-04／feature-23.md／新規で鍵32文字未満時。apps/web/src/app/ec-commerce/connector-panel.tsx:152／92件PASS／コード読み／確度中／#617 |
...
| E-05 | 軽 | 28 予約設定 | 休止中メニューの担当欄が割当済みでも「だれもいません」と誤表示する | PR審査 | [#953](https://github.com/kentavndng/line-harness-board/issues/953) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 phase0-m2 E-05／booking/menus/page.tsxの担当表示分岐、契約6件PASS／#618 |
| E-09 | 中 | 28 予約設定 | 登録した例外日を画面から修正・削除できない | PR審査 | [#953](https://github.com/kentavndng/line-harness-board/issues/953) | [#359](https://github.com/skmtmst/line-harness-oss/pull/359) | 列車待ち | 未反映 phase0-m2 E-09／画面→client→Worker→DB経路、Worker11件・Web6件PASS／#618 |
