...
比較済み **272** ／ 比較不可 **0** ／ 注意 **10**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| | **合計** | **272** | **262** | **268** | **0** | **0** | **0** | **0** | **272** | **10** | **0** | **0** | **0** | **10** | |
...
| 1 | `NjK9q` | 1-1-3 対応受信の表示件数を開く | 5.1344% | +157px ⚠ | 中央・右 | docs | [差分画像](dashboard-v6/NjK9q-diff-1920.png) | **一致** |
| 1 | `Alekb` | 1-1-4 通知パネルを開く | 5.1265% | +157px ⚠ | 中央・右 | docs | [差分画像](dashboard-v6/Alekb-diff-1920.png) | **一致** |
...
| 3 | `PhxG6` | 3-1 友だち | 4.9766% | 0px | 上部・右 | docs | [差分画像](friends-v6/PhxG6-diff-1920.png) | **一致** |
| 3 | `LT8RS` | 3-1-A 友だち（表示件数を開く） | 5.0010%（前回値） | 0px | 中央・左 | docs | [差分画像](friends-v6/LT8RS-diff-1920.png) | **一致** |
| 3 | `Igi72` | 3-1-B 友だち（詳細検索・14軸） | 4.7296% | 0px | 下部・中央 | docs | [差分画像](friends-v6/Igi72-diff-1920.png) | **一致** |
...
| 5 | `TC1b1` | 5-1 シナリオ配信 | 4.1171% | 0px | 上部・左 | docs | [差分画像](scenarios-v6/TC1b1-diff-1920.png) | **一致** |
...
| 5 | `xfYLn` | 5-1-D シナリオ・ステップ編集 | 7.9981% | 0px | 上部・右 | docs | [差分画像](scenarios-v6/xfYLn-diff-1920.png) | **一致** |
...
| 6 | `q76C35` | 6-1 一斉配信 | 3.4406% | 0px | 上部・左 | docs | [差分画像](broadcasts-v6/q76C35-diff-1920.png) | **一致** |
...
| 9 | `ec9vg` | 9-1-F 最終確認 | 7.8586% | 0px | 中央・右 | docs | [差分画像](friend-add-v6/ec9vg-diff-1920.png) | **一致** |
...
| 11 | `NNDMR` | 11-1-C 質問を作る | 6.5885% | 0px | 上部・右 | docs | [差分画像](templates-v6/NNDMR-diff-1920.png) | **一致** |
...
| 11 | `M9cij` | 11-1-G テンプレートの削除確認 | 5.0672% | 0px | 上部・左 | docs | [差分画像](templates-v6/M9cij-diff-1920.png) | **一致** |
...
| 12 | `RW5Tb` | 12-1-G 一覧の状態（空・読込・エラー） | 3.0153% | 0px | 上部・左 | docs | [差分画像](rich-menus-v6/RW5Tb-diff-1920.png) | **一致** |
| 13 | `EMBIK` | 13-1 回答フォーム | 3.8437% | 0px | 上部・左 | docs | [差分画像](forms-v6/EMBIK-diff-1920.png) | **一致** |
...
| 14 | `WuKzU` | 14-1 共通情報 | 3.6448% | 0px | 上部・左 | docs | [差分画像](common-vars-v6/WuKzU-diff-1920.png) | **一致** |
...
| 15 | `g89Tc` | 15-1 登録メディア | 3.6649% | 0px | 上部・左 | docs | [差分画像](media-v6/g89Tc-diff-1920.png) | **一致** |
...
| 15 | `h8pBZr` | 15-1-D 一覧の状態（空・読込・エラー） | 4.3401% | 0px | 上部・左 | docs | [差分画像](media-v6/h8pBZr-diff-1920.png) | **一致** |
...
| 17 | `MvZm5` | 17-1-C マイルの履歴 | 5.0035% | 0px | 上部・左 | docs | [差分画像](mileage-v6/MvZm5-diff-1920.png) | **一致** |
...
| 17 | `p9CcEB` | 17-1-G マイルの使い道をつくる | 6.3872% | +7px | 上部・右 | docs | [差分画像](mileage-v6/p9CcEB-diff-1920.png) | **一致** |
...
| 17 | `s6MBc` | 17-2-A スコアのルール | 5.0518% | +229px ⚠ | 中央・左 | docs | [差分画像](mileage-v6/s6MBc-diff-1920.png) | **一致** |
...
| 21 | `VLMGH` | 21-1 NEN配信 | 3.5689% | -1px | 中央・左 | docs | [差分画像](nen-v6/VLMGH-diff-1920.png) | **一致** |
| 21 | `DEX0k` | 21-1-A NENコラム | 3.2829% | 0px | 中央・中央 | docs | [差分画像](nen-v6/DEX0k-diff-1920.png) | **一致** |
| 21 | `q4lajm` | 21-1-B ペット・記念日 | 9.0065% | +147px ⚠ | 中央・右 | docs | [差分画像](nen-v6/q4lajm-diff-1920.png) | **一致** |
| 21 | `WeXbL` | 21-1-C NEN配信の履歴 | 3.0024% | -1px | 上部・左 | docs | [差分画像](nen-v6/WeXbL-diff-1920.png) | **一致** |
| 21 | `HpKyF` | 21-1-D NEN配信の中身を編集する | 5.7424% | 0px | 中央・右 | docs | [差分画像](nen-v6/HpKyF-diff-1920.png) | **一致** |
| 21 | `ymXJK` | 21-1-E コラムを書く | 6.5712% | +188px ⚠ | 中央・右 | docs | [差分画像](nen-v6/ymXJK-diff-1920.png) | **一致** |
| 21 | `i9sQP` | 21-1-F NENコラム・一覧の状態 | 2.7067% | 0px | 上部・中央 | docs | [差分画像](nen-v6/i9sQP-diff-1920.png) | **一致** |
...
| 23 | `ELayY` | 23-1-A 会員のつき合わせ | 3.5781% | 0px | 中央・左 | docs | [差分画像](ec-v6/ELayY-diff-1920.png) | **一致** |
| 23 | `bfB50` | 23-1-B 定期便 | 4.7276% | 0px | 中央・左 | docs | [差分画像](ec-v6/bfB50-diff-1920.png) | **一致** |
| 23 | `oHAN4` | 23-1-C EC連携のつなぎ先 | 4.2292% | 0px | 下部・左 | docs | [差分画像](ec-v6/oHAN4-diff-1920.png) | **一致** |
...
| 24 | `X8JCA5` | 24-1-B 送れなかったもの | 3.3587% | 0px | 上部・中央 | docs | [差分画像](line-notify-v6/X8JCA5-diff-1920.png) | **一致** |
| 24 | `Se65i` | 24-1-C お知らせの記録 | 3.8607% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/Se65i-diff-1920.png) | **一致** |
| 24 | `DpxOK` | 24-2 運用者へのお知らせ | 3.6342% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/DpxOK-diff-1920.png) | **一致** |
...
| 25 | `DkPY0` | 25-1-B オートメーションが動いた記録 | 5.2134% | 0px | 中央・左 | docs | [差分画像](automations-v6/DkPY0-diff-1920.png) | **一致** |
...
| 27 | `SbuUI` | 27-1-C 今週の予約 | 4.8734% | 0px | 上部・左 | docs | [差分画像](booking-v6/SbuUI-diff-1920.png) | **一致** |
...
| 29 | `ugP5y` | 29-1 イベント予約 | 3.8589% | 0px | 中央・左 | docs | [差分画像](events-v6/ugP5y-diff-1920.png) | **一致** |
| 29 | `MKrPY` | 29-1-A イベントをつくる | 6.3529% | 0px | 中央・右 | docs | [差分画像](events-v6/MKrPY-diff-1920.png) | **一致** |
| 29 | `i5SN2j` | 29-1-B 申込者の一覧 | 3.1513% | 0px | 上部・左 | docs | [差分画像](events-v6/i5SN2j-diff-1920.png) | **一致** |
| 29 | `k5m5Bc` | 29-1-C 一覧の状態（空・読込・エラー） | 3.3337% | 0px | 中央・左 | docs | [差分画像](events-v6/k5m5Bc-diff-1920.png) | **一致** |
...
| 30 | `I3ZSrU` | 30-1-C 人を招待する | 4.7177% | -56px ⚠ | 中央・左 | docs | [差分画像](staff-v6/I3ZSrU-diff-1920.png) | **一致** |
...
| 32 | `b3HfZ` | 32-1-A 緊急コントロール | 5.3682% | -56px ⚠ | 中央・右 | docs | [差分画像](operations-v6/b3HfZ-diff-1920.png) | **一致** |
| 32 | `UhC2O` | 32-1-B 更新履歴 | 4.8966% | +445px ⚠ | 中央・左 | docs | [差分画像](operations-v6/UhC2O-diff-1920.png) | **一致** |
...
| 4 | `GMvBd` | 4-3-A 対応マークを追加・編集 | 3.0484% | 0px | 上部・左 | docs | [差分画像](friend-attributes-v6/GMvBd-diff-1920.png) | **一致** |
...
| 3 | `ux7of` | 3-4-A UID・顧客データ移行／CSV | 5.0832% | 0px | 中央・左 | docs | [差分画像](friends-v6/ux7of-diff-1920.png) | **一致** |
