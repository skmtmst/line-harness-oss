...
| | **合計** | **272** | **266** | **268** | **0** | **0** | **0** | **0** | **250** | **36** | **22** | **0** | **0** | **6** | |
...
| 2 | `ANgda` | 2-14 保存した検索名を入力 | 19.8640% ⚠ | 0px | 上部・右 | docs | [差分画像](inbox-v6/ANgda-diff-1920.png) | **一致** |
| 2 | `tBlkL` | 2-15 保存した検索・保存完了 | 7.8207% | 0px | 上部・中央 | — | [差分画像](inbox-v6/tBlkL-diff-1920.png) | **一致** |
| 2 | `AuSDY` | 2-16 保存した検索名・未入力エラー | 19.2671% ⚠ | 0px | 上部・右 | docs | [差分画像](inbox-v6/AuSDY-diff-1920.png) | **一致** |
| 2 | `LHjwD` | 2-17 保存した検索名・重複エラー | 19.2415% ⚠ | 0px | 上部・右 | docs | [差分画像](inbox-v6/LHjwD-diff-1920.png) | **一致** |
...
| 7 | `uJP22` | 7-1-A リマインダを作成 | 12.2010% ⚠ | +65px | 中央・右 | docs | [差分画像](reminders-v6/uJP22-diff-1920.png) | **一致** |
| 7 | `J64xI` | 7-1-B 通知ステップ編集 | 11.3606% ⚠ | +93px | 中央・右 | docs | [差分画像](reminders-v6/J64xI-diff-1920.png) | **一致** |
...
| 7 | `W98zZQ` | 7-1-E テスト送信確認 | 18.6563% ⚠ | 0px | 中央・中央 | docs | [差分画像](reminders-v6/W98zZQ-diff-1920.png) | **一致** |
...
| 7 | `Y0Sn3` | 7-1-I 削除確認 | 13.7618% ⚠ | 0px | 中央・中央 | docs | [差分画像](reminders-v6/Y0Sn3-diff-1920.png) | **一致** |
...
| 8 | `K7vg2` | 8-1-A 自動応答ルール編集 | 10.9163% ⚠ | +36px | 中央・右 | docs | [差分画像](auto-replies-v6/K7vg2-diff-1920.png) | **一致** |
| 8 | `nzWIX` | 8-1-B 反応条件 | 4.8555% | +131px | 中央・左 | — | [差分画像](auto-replies-v6/nzWIX-diff-1920.png) | **一致** |
| 8 | `ivDoe` | 8-1-C 応答とアクション | 11.4415% ⚠ | -56px | 中央・右 | docs | [差分画像](auto-replies-v6/ivDoe-diff-1920.png) | **一致** |
...
| 8 | `Gy9OK` | 8-1-I 削除確認 | 14.6388% ⚠ | 0px | 中央・中央 | docs | [差分画像](auto-replies-v6/Gy9OK-diff-1920.png) | **一致** |
