...
総数 **272** ／ 比較済み **261** ／ 未実装 **0** ／ 未確認 **0** ／ 別の仕掛けで撮影 **0** ／ 未撮影 **11**
...
比較済み **272** ／ 比較不可 **0** ／ 注意 **58**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| | **合計** | **272** | **261** | **268** | **0** | **0** | **0** | **0** | **272** | **58** | **0** | **0** | **0** | **11** | |
...
| 11 | `NNDMR` | 11-1-C 質問を作る | 7.0482% | 0px | 上部・右 | docs | [差分画像](templates-v6/NNDMR-diff-1920.png) | **一致** |
...
| 23 | `oHAN4` | 23-1-C EC連携のつなぎ先 | 4.2002% | 0px | 下部・左 | docs | [差分画像](ec-v6/oHAN4-diff-1920.png) | **一致** |
| 24 | `festr` | 24-1 LINE通知 | 4.8107% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/festr-diff-1920.png) | **一致** |
...
| 24 | `N2gAza` | 24-2-A 運用者へのお知らせをつくる | 4.1880% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/N2gAza-diff-1920.png) | **一致** |
...
| 4 | `hqrOv` | 4-1 友だち属性・タグ | 3.9584% | 0px | 上部・左 | docs | [差分画像](friend-attributes-v6/hqrOv-diff-1920.png) | **一致** |
...
| 4 | `tP0RW` | 4-1-B タグを作る・連動ON | 5.3779% | 0px | 中央・左 | docs | [差分画像](friend-attributes-v6/tP0RW-diff-1920.png) | **一致** |
| 4 | `LfrQs` | 4-1-C 連動アクション追加ドロワー | 4.8876%（前回値） | 0px | 上部・右 | docs | [差分画像](friend-attributes-v6/LfrQs-diff-1920.png) | **一致** |
| 4 | `ee0sk` | 4-1-D タグを編集・既存設定あり | 5.3388% | +6px | 下部・左 | docs | [差分画像](friend-attributes-v6/ee0sk-diff-1920.png) | **一致** |
...
| 4 | `KoT6c` | 4-2-B 友だち情報欄・項目移行 | 3.3877% | 0px | 中央・左 | docs | [差分画像](friend-attributes-v6/KoT6c-diff-1920.png) | **一致** |
...
| 4 | `XBkiQ` | 4-4-A 保存した検索の条件確認・編集 | 4.8267% | 0px | 中央・左 | docs | [差分画像](friend-attributes-v6/XBkiQ-diff-1920.png) | **一致** |
