...
比較済み **215** ／ 比較不可 **57** ／ 10%超 **46**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| 16 | 成果とアフィリエイト | 9 | 7 | 9 | 0 | 0 | 0 | 0 | 6 | 1 | 3 | 0 | 0 | 2 | #1230 `b62d7d070` 2026-09-07（QX70l）<br>#1180 `3721857fb` 2026-09-07（jwrbf・GqFTV・njLGA）<br>#558 `ef7b5773` 2026-08-29（PouPn・xqT1Z・jwrbf）<br>#563 `64798425` 2026-08-29（jwrbf）<br>#0 `c275749d` 2026-08-30（PouPn・GH8VL・n5VVTb・xqT1Z・GPWzq）<br>#585 `75d6eb9a` 2026-08-30（njLGA）<br>#585 `3857365b` 2026-08-30（njLGA）<br>#667 `7d830282` 2026-09-02（n5VVTb・PouPn・GH8VL・njLGA・GPWzq・xqT1Z） |
...
| | **合計** | **272** | **258** | **268** | **0** | **0** | **0** | **0** | **215** | **46** | **57** | **0** | **0** | **14** | |

## 画面ごとの画素差

| 機能 | Node | 画面 | 差分率 | 高さ差 | 差分の中心 | 証拠 | 判定 |
|---|---|---|---:|---:|---|---|---|
| 1 | `vUXKb` | 1-1 ダッシュボード | 4.0275% | +173px | 中央・右 | [差分画像](dashboard-v6/vUXKb-diff-1920.png) | **一致** |
| 1 | `ZN0ov` | 1-1-1 ダッシュボード編集 | 4.8383% | 0px | 下部・右 | [差分画像](dashboard-v6/ZN0ov-diff-1920.png) | **一致** |
| 1 | `JN6mQ` | 1-1-2 友だち追加QR | 14.3675% ⚠ | 0px | 下部・中央 | [差分画像](dashboard-v6/JN6mQ-diff-1920.png) | **一致** |
| 1 | `NjK9q` | 1-1-3 対応受信の表示件数を開く | 4.9630% | +173px | 中央・右 | [差分画像](dashboard-v6/NjK9q-diff-1920.png) | **一致** |
| 1 | `Alekb` | 1-1-4 通知パネルを開く | 4.9828% | +173px | 中央・右 | [差分画像](dashboard-v6/Alekb-diff-1920.png) | **一致** |
| 2 | `xGLVe` | 2-1 受信箱 | 6.8945% | 0px | 上部・中央 | [差分画像](inbox-v6/xGLVe-diff-1920.png) | **一致** |
| 2 | `NfgOs` | 2-2 テンプレート選択 | 59.9766% ⚠ | 0px | 下部・左 | [差分画像](inbox-v6/NfgOs-diff-1920.png) | **一致** |
...
| 3 | `LT8RS` | 3-1-A 友だち（表示件数を開く） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `Igi72` | 3-1-B 友だち（詳細検索・14軸） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `IAf7j` | 3-1-C 友だち（一括操作） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `I6UAdr` | 3-1-D 友だち詳細 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `bzDn6` | 3-1-E 友だち一覧の状態（空・読込・エラー） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `YzxU1` | 3-2 重複検出 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `InCDe` | 3-2-A 重複候補詳細・統合前確認 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 3 | `r7eSi` | 3-3 統合ユーザー | 3.8002% | 0px | 中央・右 | [差分画像](friends-v6/r7eSi-diff-1920.png) | **一致** |
| 3 | `w8W4Eh` | 3-3-A 統合ユーザー詳細 | 4.8487% | 0px | 中央・中央 | [差分画像](friends-v6/w8W4Eh-diff-1920.png) | **一致** |
| 3 | `vtBCu` | 3-4 UID移行 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 5 | `TC1b1` | 5-1 シナリオ配信 | 3.7948% | 0px | 中央・中央 | [差分画像](scenarios-v6/TC1b1-diff-1920.png) | **一致** |
...
| 5 | `r6Gzsu` | 5-1-E シナリオ・配信条件を開く | 23.7417% ⚠ | 0px | 上部・右 | [差分画像](scenarios-v6/r6Gzsu-diff-1920.png) | **一致** |
| 5 | `hz9ti` | 5-1-F シナリオ・送信後アクションを開く | 20.1376% ⚠ | 0px | 上部・右 | [差分画像](scenarios-v6/hz9ti-diff-1920.png) | **一致** |
| 5 | `dqFft` | 5-1-G シナリオ・ステップ削除確認 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 5 | `EvVO5` | 5-1-H シナリオ・開始条件を開く | 38.6767% ⚠ | 0px | 下部・中央 | [差分画像](scenarios-v6/EvVO5-diff-1920.png) | **一致** |
| 5 | `RUxNf` | 5-1-I シナリオ・配信開始確認 | 27.0335% ⚠ | 0px | 下部・中央 | [差分画像](scenarios-v6/RUxNf-diff-1920.png) | **一致** |
| 5 | `NrBkW` | 5-1-J シナリオ・配信開始完了 | 5.4857% | +8px | 上部・左 | [差分画像](scenarios-v6/NrBkW-diff-1920.png) | **一致** |
| 5 | `g2UNV` | 5-1-K シナリオ・テスト送信 | 49.1472% ⚠ | 0px | 上部・中央 | [差分画像](scenarios-v6/g2UNV-diff-1920.png) | **一致** |
| 5 | `M2b2B` | 5-1-L シナリオ・配信結果 | 3.8932% | 0px | 中央・右 | [差分画像](scenarios-v6/M2b2B-diff-1920.png) | **一致** |
| 5 | `q5G45` | 5-1-M 一覧の状態（空・読込・エラー） | 2.9600% | 0px | 上部・左 | [差分画像](scenarios-v6/q5G45-diff-1920.png) | **一致** |
| 6 | `q76C35` | 6-1 一斉配信 | 3.3445% | 0px | 上部・左 | [差分画像](broadcasts-v6/q76C35-diff-1920.png) | **一致** |
...
| 6 | `p97Tf` | 6-1-D テンプレート選択 | 23.0279% ⚠ | 0px | 中央・中央 | [差分画像](broadcasts-v6/p97Tf-diff-1920.png) | **一致** |
| 6 | `Bw0zt` | 6-1-E 送信設定 | 11.6072% ⚠ | 0px | 下部・右 | [差分画像](broadcasts-v6/Bw0zt-diff-1920.png) | **一致** |
| 6 | `h0kahp` | 6-1-F テスト送信 | 23.4829% ⚠ | 0px | 中央・中央 | [差分画像](broadcasts-v6/h0kahp-diff-1920.png) | **一致** |
| 6 | `vW4Es` | 6-1-G 配信前チェック | 21.4918% ⚠ | +3px | 中央・中央 | [差分画像](broadcasts-v6/vW4Es-diff-1920.png) | **一致** |
...
| 8 | `q8wSqO` | 8-1-J 一覧の状態（空・読込・エラー） | 3.5103% | 0px | 上部・左 | [差分画像](auto-replies-v6/q8wSqO-diff-1920.png) | **一致** |
...
| 9 | `ec9vg` | 9-1-F 最終確認 | 9.2047% | -56px | 中央・右 | [差分画像](friend-add-v6/ec9vg-diff-1920.png) | **一致** |
| 9 | `quhg6` | 9-1-G 有効化完了 | 3.1678% | 0px | 上部・左 | [差分画像](friend-add-v6/quhg6-diff-1920.png) | **一致** |
...
| 11 | `M9cij` | 11-1-G テンプレートの削除確認 | 8.4232% | -1px | 中央・右 | [差分画像](templates-v6/M9cij-diff-1920.png) | **一致** |
| 11 | `CzndJ` | 11-1-H フォルダ操作 | 5.0695% | 0px | 中央・中央 | [差分画像](templates-v6/CzndJ-diff-1920.png) | **一致** |
| 11 | `NKyoA` | 11-1-I 一覧の状態（空・読込・エラー） | 2.5950% | 0px | 上部・左 | [差分画像](templates-v6/NKyoA-diff-1920.png) | **一致** |
...
| 12 | `DIUbO` | 12-1-C 切替メニューのつながり | 6.6398% | 0px | 上部・右 | [差分画像](rich-menus-v6/DIUbO-diff-1920.png) | **一致** |
| 12 | `NXdDk` | 12-1-C-A つながりなし | 5.5406% | 0px | 上部・右 | [差分画像](rich-menus-v6/NXdDk-diff-1920.png) | **一致** |
...
| 12 | `RW5Tb` | 12-1-G 一覧の状態（空・読込・エラー） | 3.0153% | 0px | 上部・左 | [差分画像](rich-menus-v6/RW5Tb-diff-1920.png) | **一致** |
...
| 13 | `ava2n` | 13-1-B フォームのデザイン設定 | 65.1371% ⚠ | +391px | 下部・右 | [差分画像](forms-v6/ava2n-diff-1920.png) | **一致** |
| 13 | `cSqvP` | 13-1-C フォームのオプション設定 | 22.1087% ⚠ | 0px | 上部・右 | [差分画像](forms-v6/cSqvP-diff-1920.png) | **一致** |
| 13 | `v9tYhl` | 13-1-D 集まった回答 | 3.3300% | 0px | 中央・左 | [差分画像](forms-v6/v9tYhl-diff-1920.png) | **一致** |
| 13 | `gBp2J` | 13-1-E フォームの削除確認 | 10.7585% ⚠ | -1px | 上部・中央 | [差分画像](forms-v6/gBp2J-diff-1920.png) | **一致** |
...
| 15 | `h8pBZr` | 15-1-D 一覧の状態（空・読込・エラー） | 3.2902% | 0px | 中央・中央 | [差分画像](media-v6/h8pBZr-diff-1920.png) | **一致** |
...
| 16 | `GqFTV` | 16-1-H 支払いを確定する | 12.0679% ⚠ | -1px | 下部・中央 | [差分画像](affiliates-v6/GqFTV-diff-1920.png) | **一致** |
| 17 | `s98Vfw` | 17-1 マイル | 4.5647% | 0px | 中央・左 | [差分画像](mileage-v6/s98Vfw-diff-1920.png) | **一致** |
| 17 | `N46cQ` | 17-1-A たまる決めごと | 5.4323% | +80px | 中央・左 | [差分画像](mileage-v6/N46cQ-diff-1920.png) | **一致** |
| 17 | `qlVLJ` | 17-1-B マイルの使い道 | 4.5295% | 0px | 中央・左 | [差分画像](mileage-v6/qlVLJ-diff-1920.png) | **一致** |
| 17 | `MvZm5` | 17-1-C マイルの履歴 | 4.7272% | +83px | 上部・左 | [差分画像](mileage-v6/MvZm5-diff-1920.png) | **一致** |
| 17 | `BmoGY` | 17-1-D たまる決めごとをつくる | 6.7937% | +645px | 上部・右 | [差分画像](mileage-v6/BmoGY-diff-1920.png) | **一致** |
| 17 | `HIU5O` | 17-1-E 友だちのマイル明細 | 5.4628% | -56px | 中央・右 | [差分画像](mileage-v6/HIU5O-diff-1920.png) | **一致** |
| 17 | `vz0Ji` | 17-1-F マイルを手で増やす・減らす | 20.0423% ⚠ | 0px | 下部・中央 | [差分画像](mileage-v6/vz0Ji-diff-1920.png) | **一致** |
| 17 | `p9CcEB` | 17-1-G マイルの使い道をつくる | 4.7491% | -56px | 上部・右 | [差分画像](mileage-v6/p9CcEB-diff-1920.png) | **一致** |
| 17 | `k8VCU` | 17-1-H たまる決めごと・一覧の状態 | 4.1206% | +80px | 上部・左 | [差分画像](mileage-v6/k8VCU-diff-1920.png) | **一致** |
| 17 | `z3PB2` | 17-2 行動スコア | 4.7051% | 0px | 上部・左 | [差分画像](mileage-v6/z3PB2-diff-1920.png) | **一致** |
| 17 | `s6MBc` | 17-2-A スコアのルール | —（設計画像なし） | — | — | — | **一致** |
| 18 | `Q4bkTg` | 18-1 流入と計測 | 5.8356% | 0px | 中央・左 | [差分画像](inflow-v6/Q4bkTg-diff-1920.png) | **一致** |
| 18 | `IhSBB` | 18-1-A サイトスクリプト | 4.9393% | -40px | 中央・右 | [差分画像](inflow-v6/IhSBB-diff-1920.png) | **一致** |
| 18 | `v0HaI` | 18-1-B 広告連携 | 3.9954% | 0px | 中央・右 | [差分画像](inflow-v6/v0HaI-diff-1920.png) | **一致** |
| 18 | `TEVk8` | 18-1-C 流入リンクをつくる | 5.1522% | +408px | 中央・左 | [差分画像](inflow-v6/TEVk8-diff-1920.png) | **一致** |
| 18 | `JupxW` | 18-1-D 流入元の詳細 | 4.2085% | 0px | 中央・左 | [差分画像](inflow-v6/JupxW-diff-1920.png) | **一致** |
...
| 18 | `BuVDB` | 18-2 広告とのつなぎ（成果の対応付け） | 4.0986% | -56px | 中央・右 | [差分画像](inflow-v6/BuVDB-diff-1920.png) | **一致** |
| 18 | `Im2b1` | 18-2-A 広告への送信履歴 | 3.9756% | 0px | 中央・左 | [差分画像](inflow-v6/Im2b1-diff-1920.png) | **一致** |
...
| 21 | `VLMGH` | 21-1 NEN配信 | 3.5689% | -1px | 中央・左 | [差分画像](nen-v6/VLMGH-diff-1920.png) | **一致** |
| 21 | `DEX0k` | 21-1-A NENコラム | 3.2829% | 0px | 中央・中央 | [差分画像](nen-v6/DEX0k-diff-1920.png) | **一致** |
| 21 | `q4lajm` | 21-1-B ペット・記念日 | 9.0065% | +147px | 中央・右 | [差分画像](nen-v6/q4lajm-diff-1920.png) | **一致** |
| 21 | `WeXbL` | 21-1-C NEN配信の履歴 | 3.0024% | -1px | 上部・左 | [差分画像](nen-v6/WeXbL-diff-1920.png) | **一致** |
| 21 | `HpKyF` | 21-1-D NEN配信の中身を編集する | 5.5549% | +28px | 中央・右 | [差分画像](nen-v6/HpKyF-diff-1920.png) | **一致** |
| 21 | `ymXJK` | 21-1-E コラムを書く | 6.5712% | +188px | 中央・右 | [差分画像](nen-v6/ymXJK-diff-1920.png) | **一致** |
| 21 | `i9sQP` | 21-1-F NENコラム・一覧の状態 | 2.7067% | 0px | 上部・中央 | [差分画像](nen-v6/i9sQP-diff-1920.png) | **一致** |
...
| 23 | `eI3gs` | 23-1 EC連携 | 4.6263% | 0px | 中央・左 | [差分画像](ec-v6/eI3gs-diff-1920.png) | **一致** |
| 23 | `ELayY` | 23-1-A 会員のつき合わせ | 3.5781% | 0px | 中央・左 | [差分画像](ec-v6/ELayY-diff-1920.png) | **一致** |
| 23 | `bfB50` | 23-1-B 定期便 | —（設計画像なし） | — | — | — | **一致** |
| 23 | `oHAN4` | 23-1-C EC連携のつなぎ先 | —（設計画像なし） | — | — | — | **一致** |
| 24 | `festr` | 24-1 LINE通知 | 4.6366% | +38px | 中央・右 | [差分画像](line-notify-v6/festr-diff-1920.png) | **一致** |
| 24 | `Q55bb` | 24-1-A お知らせの中身を編集する | 7.7882% | 0px | 中央・右 | [差分画像](line-notify-v6/Q55bb-diff-1920.png) | **一致** |
| 24 | `X8JCA5` | 24-1-B 送れなかったもの | 3.3587% | 0px | 上部・中央 | [差分画像](line-notify-v6/X8JCA5-diff-1920.png) | **一致** |
| 24 | `Se65i` | 24-1-C お知らせの記録 | 3.8607% | 0px | 中央・左 | [差分画像](line-notify-v6/Se65i-diff-1920.png) | **一致** |
| 24 | `DpxOK` | 24-2 運用者へのお知らせ | 3.6342% | 0px | 中央・左 | [差分画像](line-notify-v6/DpxOK-diff-1920.png) | **一致** |
| 24 | `N2gAza` | 24-2-A 運用者へのお知らせをつくる | 4.1587% | +33px | 中央・左 | [差分画像](line-notify-v6/N2gAza-diff-1920.png) | **一致** |
| 25 | `gief7` | 25-1 オートメーション | 4.9872% | 0px | 中央・左 | [差分画像](automations-v6/gief7-diff-1920.png) | **一致** |
| 25 | `Rv8Jv` | 25-1-A オートメーションをつくる | 6.1363% | +169px | 中央・左 | [差分画像](automations-v6/Rv8Jv-diff-1920.png) | **一致** |
| 25 | `DkPY0` | 25-1-B オートメーションが動いた記録 | 5.2134% | 0px | 中央・左 | [差分画像](automations-v6/DkPY0-diff-1920.png) | **一致** |
| 25 | `WjYAC` | 25-1-C 見本から作る | 4.9944% | 0px | 中央・中央 | [差分画像](automations-v6/WjYAC-diff-1920.png) | **一致** |
| 25 | `Vdbv5` | 25-1-D 一覧の状態（空・読込・エラー） | 4.2691% | 0px | 中央・左 | [差分画像](automations-v6/Vdbv5-diff-1920.png) | **一致** |
| 25 | `xOpDs` | 25-2 共通アクション | 5.0000% | 0px | 中央・左 | [差分画像](automations-v6/xOpDs-diff-1920.png) | **一致** |
| 25 | `py5CG` | 25-2-A 共通アクションをつくる | 4.1083% | +85px | 中央・右 | [差分画像](automations-v6/py5CG-diff-1920.png) | **一致** |
| 25 | `syWp4` | 25-2-B 共通アクションの版と使われている場所 | 4.6105% | +220px | 上部・左 | [差分画像](automations-v6/syWp4-diff-1920.png) | **一致** |
...
| 26 | `KNG00` | 26-1-B やり取りの記録 | 4.8813% | 0px | 中央・左 | [差分画像](webhooks-v6/KNG00-diff-1920.png) | **一致** |
| 26 | `f8SBSh` | 26-1-C 一覧の状態（空・読込・エラー） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 27 | `TV2DI` | 27-1 予約管理 | 4.4988% | -64px | 中央・右 | [差分画像](booking-v6/TV2DI-diff-1920.png) | **一致** |
...
| 27 | `SbuUI` | 27-1-C 今週の予約 | 4.4458% | +75px | 上部・左 | [差分画像](booking-v6/SbuUI-diff-1920.png) | **一致** |
...
| 28 | `QSLEH` | 28-1 予約設定 | 3.2861% | 0px | 中央・右 | [差分画像](booking-settings-v6/QSLEH-diff-1920.png) | **一致** |
| 28 | `tksPc` | 28-1-A 受付枠と休業日 | 5.7564% | +171px | 中央・右 | [差分画像](booking-settings-v6/tksPc-diff-1920.png) | **一致** |
| 28 | `GhOb3` | 28-1-B 予約メニューをつくる | 6.6554% | +658px | 上部・右 | [差分画像](booking-settings-v6/GhOb3-diff-1920.png) | **一致** |
| 28 | `W6465r` | 28-1-C 一覧の状態（空・読込・エラー） | 1.3967% | 0px | 中央・中央 | [差分画像](booking-settings-v6/W6465r-diff-1920.png) | **一致** |
| 29 | `ugP5y` | 29-1 イベント予約 | 3.8589% | 0px | 中央・左 | [差分画像](events-v6/ugP5y-diff-1920.png) | **一致** |
| 29 | `MKrPY` | 29-1-A イベントをつくる | 5.9053% | +642px | 中央・右 | [差分画像](events-v6/MKrPY-diff-1920.png) | **一致** |
| 29 | `i5SN2j` | 29-1-B 申込者の一覧 | 3.1513% | 0px | 上部・左 | [差分画像](events-v6/i5SN2j-diff-1920.png) | **一致** |
| 29 | `k5m5Bc` | 29-1-C 一覧の状態（空・読込・エラー） | 3.3337% | 0px | 中央・左 | [差分画像](events-v6/k5m5Bc-diff-1920.png) | **一致** |
| 30 | `e3jz3` | 30-1 ログインユーザー | 4.4622% | +178px | 中央・左 | [差分画像](staff-v6/e3jz3-diff-1920.png) | **一致** |
| 30 | `EOTS4` | 30-1-A 見せる範囲を決める | 4.8683% | 0px | 中央・左 | [差分画像](staff-v6/EOTS4-diff-1920.png) | **一致** |
| 30 | `jwVlo` | 30-1-B 入った記録 | 4.7959% | 0px | 中央・左 | [差分画像](staff-v6/jwVlo-diff-1920.png) | **一致** |
...
| 32 | `b3HfZ` | 32-1-A 緊急コントロール | 5.3682% | -56px | 中央・右 | [差分画像](operations-v6/b3HfZ-diff-1920.png) | **一致** |
| 32 | `UhC2O` | 32-1-B 更新履歴 | 4.8966% | +445px | 中央・左 | [差分画像](operations-v6/UhC2O-diff-1920.png) | **一致** |
...
| 4 | `dKlkz` | 4-1-F タグ削除の確認ダイアログ | 10.5226% ⚠ | 0px | 下部・中央 | [差分画像](friend-attributes-v6/dKlkz-diff-1920.png) | **一致** |
| 4 | `H374MR` | 4-1-H タグCSV一括登録 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 4 | `sfTEW` | 4-1-H-A CSV取り込み・確認（dry-run） | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 4 | `op1rh` | 4-1-H-B CSV取り込み・完了 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 4 | `QzRsJ` | 4-1-H-C CSV取り込み・一部失敗 | —（実装画像なし（1920px）） | — | — | — | **一致** |
| 4 | `HBTk0` | 4-2 友だち情報欄 | 3.4768% | 0px | 中央・中央 | [差分画像](friend-attributes-v6/HBTk0-diff-1920.png) | **一致** |
| 4 | `yKEdO` | 4-2-C 一覧の状態（空・読込・エラー） | 3.2602% | 0px | 上部・左 | [差分画像](friend-attributes-v6/yKEdO-diff-1920.png) | **一致** |
| 4 | `rIhbN` | 4-3 対応マーク | 3.3992% | 0px | 中央・中央 | [差分画像](friend-attributes-v6/rIhbN-diff-1920.png) | **一致** |
| 4 | `QKx8Q` | 4-4 保存した検索 | 3.8077% | 0px | 中央・左 | [差分画像](friend-attributes-v6/QKx8Q-diff-1920.png) | **一致** |
| 4 | `l25rlp` | 4-1-A タグを作る・初期状態 | 4.1692% | +4px | 中央・左 | [差分画像](friend-attributes-v6/l25rlp-diff-1920.png) | **一致** |
| 4 | `tP0RW` | 4-1-B タグを作る・連動ON | 5.1001% | +226px | 中央・左 | [差分画像](friend-attributes-v6/tP0RW-diff-1920.png) | **一致** |
| 4 | `LfrQs` | 4-1-C 連動アクション追加ドロワー | 4.7404% | 0px | 上部・右 | [差分画像](friend-attributes-v6/LfrQs-diff-1920.png) | **一致** |
| 4 | `ee0sk` | 4-1-D タグを編集・既存設定あり | 4.9532% | +242px | 下部・左 | [差分画像](friend-attributes-v6/ee0sk-diff-1920.png) | **一致** |
| 4 | `VjXGX` | 4-1-E 遡及反映の確認ダイアログ | 19.2611% ⚠ | 0px | 下部・中央 | [差分画像](friend-attributes-v6/VjXGX-diff-1920.png) | **一致** |
...
| 4 | `KoT6c` | 4-2-B 友だち情報欄・項目移行 | 3.2107% | +112px | 中央・左 | [差分画像](friend-attributes-v6/KoT6c-diff-1920.png) | **一致** |
| 4 | `GMvBd` | 4-3-A 対応マークを追加・編集 | 3.0484% | 0px | 上部・左 | [差分画像](friend-attributes-v6/GMvBd-diff-1920.png) | **一致** |
| 4 | `zGZMA` | 4-3-B 対応マーク削除の確認ダイアログ | 16.1415% ⚠ | 0px | 中央・中央 | [差分画像](friend-attributes-v6/zGZMA-diff-1920.png) | **一致** |
| 4 | `XBkiQ` | 4-4-A 保存した検索の条件確認・編集 | 4.6373% | +68px | 中央・左 | [差分画像](friend-attributes-v6/XBkiQ-diff-1920.png) | **一致** |
