...
比較済み **251** ／ 比較不可 **21** ／ 10%超 **29**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| | **合計** | **272** | **266** | **268** | **0** | **0** | **0** | **0** | **251** | **29** | **21** | **0** | **0** | **6** | |
...
| 25 | `gief7` | 25-1 オートメーション | 5.1613%（前回値） | 0px | 中央・左 | — | [差分画像](automations-v6/gief7-diff-1920.png) | **一致** |
| 25 | `Rv8Jv` | 25-1-A オートメーションをつくる | 6.1060%（前回値） | +169px | 中央・左 | — | [差分画像](automations-v6/Rv8Jv-diff-1920.png) | **一致** |
| 25 | `DkPY0` | 25-1-B オートメーションが動いた記録 | 5.3876%（前回値） | 0px | 中央・左 | — | [差分画像](automations-v6/DkPY0-diff-1920.png) | **一致** |
| 25 | `WjYAC` | 25-1-C 見本から作る | 5.1685%（前回値） | 0px | 中央・中央 | — | [差分画像](automations-v6/WjYAC-diff-1920.png) | **一致** |
| 25 | `Vdbv5` | 25-1-D 一覧の状態（空・読込・エラー） | 4.4432%（前回値） | 0px | 中央・左 | — | [差分画像](automations-v6/Vdbv5-diff-1920.png) | **一致** |
| 25 | `xOpDs` | 25-2 共通アクション | 5.2763%（前回値） | 0px | 中央・左 | — | [差分画像](automations-v6/xOpDs-diff-1920.png) | **一致** |
| 25 | `py5CG` | 25-2-A 共通アクションをつくる | 4.2824%（前回値） | +85px | 中央・右 | — | [差分画像](automations-v6/py5CG-diff-1920.png) | **一致** |
| 25 | `syWp4` | 25-2-B 共通アクションの版と使われている場所 | 4.7846%（前回値） | +220px | 上部・左 | — | [差分画像](automations-v6/syWp4-diff-1920.png) | **一致** |
...
| 26 | `f8SBSh` | 26-1-C 一覧の状態（空・読込・エラー） | 3.8223%（前回値） | 0px | 中央・中央 | — | [差分画像](webhooks-v6/f8SBSh-diff-1920.png) | **一致** |
| 27 | `TV2DI` | 27-1 予約管理 | 4.6730%（前回値） | -64px | 中央・右 | — | [差分画像](booking-v6/TV2DI-diff-1920.png) | **一致** |
...
| 27 | `SbuUI` | 27-1-C 今週の予約 | 4.4693%（前回値） | 0px | 中央・左 | — | [差分画像](booking-v6/SbuUI-diff-1920.png) | **一致** |
...
| 28 | `QSLEH` | 28-1 予約設定 | 3.4602%（前回値） | 0px | 中央・左 | — | [差分画像](booking-settings-v6/QSLEH-diff-1920.png) | **一致** |
| 28 | `tksPc` | 28-1-A 受付枠と休業日 | 5.9219%（前回値） | +171px | 中央・右 | — | [差分画像](booking-settings-v6/tksPc-diff-1920.png) | **一致** |
| 28 | `GhOb3` | 28-1-B 予約メニューをつくる | 6.8295%（前回値） | +658px | 上部・右 | — | [差分画像](booking-settings-v6/GhOb3-diff-1920.png) | **一致** |
| 28 | `W6465r` | 28-1-C 一覧の状態（空・読込・エラー） | 2.8767%（前回値） | 0px | 中央・中央 | — | [差分画像](booking-settings-v6/W6465r-diff-1920.png) | **一致** |
