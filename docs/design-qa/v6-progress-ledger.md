...
比較済み **250** ／ 比較不可 **22** ／ 10%超 **40**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| | **合計** | **272** | **255** | **268** | **0** | **0** | **0** | **0** | **250** | **40** | **22** | **0** | **4** | **13** | |
