...
比較済み **225** ／ 比較不可 **47** ／ 10%超 **37**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| 25 | オートメーション | 8 | 8 | 8 | 0 | 0 | 0 | 0 | 0 | 0 | 8 | 0 | 0 | 0 | #0 `e20d921b8` 2026-09-07（Rv8Jv・DkPY0・py5CG）<br>#502 `75b010fc` 2026-08-28（DkPY0）<br>#552 `6ce43563` 2026-08-29（gief7・Rv8Jv・WjYAC・Vdbv5）<br>#0 `c275749d` 2026-08-30（xOpDs・py5CG・syWp4）<br>#0 `2d0ee180` 2026-08-30（xOpDs・py5CG・syWp4）<br>#594 `a389b70a` 2026-08-30（syWp4）<br>#989 `44e671b2c` 2026-09-06（gief7・Rv8Jv・WjYAC・Vdbv5・xOpDs・py5CG・syWp4）<br>#1055 `08369795c` 2026-09-07（gief7・Rv8Jv・DkPY0・WjYAC・py5CG）<br>#1151 `bd900c36d` 2026-09-07（gief7・Rv8Jv・DkPY0・WjYAC・Vdbv5・xOpDs・py5CG・syWp4） |
| 26 | 外部連携 | 4 | 4 | 4 | 0 | 0 | 0 | 0 | 3 | 1 | 1 | 0 | 0 | 0 | #547 `48715569` 2026-08-29（KNG00）<br>#515 `09054b78` 2026-08-29（f8SBSh）<br>#527 `c6fd4388` 2026-08-29（k3WxrO・f8SBSh）<br>#0 `c275749d` 2026-08-30（M0Gb7） |
| 27 | 予約管理 | 7 | 7 | 7 | 0 | 0 | 0 | 0 | 5 | 0 | 2 | 0 | 0 | 0 | #0 `e20d921b8` 2026-09-07（TnDbq・GFDqW・GfceK・Lg8ff）<br>#459 `ba0bf62d` 2026-08-29（GFDqW・GfceK・Lg8ff）<br>#562 `45789965` 2026-08-29（Lg8ff）<br>#0 `c275749d` 2026-08-30（TV2DI・TnDbq・SbuUI）<br>#587 `425a6b1a` 2026-08-30（GFDqW・GfceK・Lg8ff） |
| 28 | 予約設定 | 4 | 4 | 4 | 0 | 0 | 0 | 0 | 0 | 0 | 4 | 0 | 0 | 0 | #1177 `7ebf0d654` 2026-09-07（tksPc・GhOb3）<br>#1126 `e1126c5c9` 2026-09-07（QSLEH・W6465r）<br>#1096 `a89279ce7` 2026-09-07（tksPc）<br>#517 `43d3d20e` 2026-08-30（tksPc）<br>#532 `6cc74968` 2026-08-29（W6465r）<br>#0 `c275749d` 2026-08-30（QSLEH・GhOb3）<br>#0 `595c8359` 2026-09-01（tksPc）<br>#1022 `abae52d46` 2026-09-07（QSLEH・GhOb3・W6465r） |
| 29 | イベント予約 | 4 | 4 | 4 | 0 | 0 | 0 | 0 | 1 | 0 | 3 | 0 | 0 | 0 | #1176 `ea4284f42` 2026-09-07（ugP5y）<br>#533 `d1070487` 2026-08-29（k5m5Bc）<br>#467 `6bb950f3` 2026-08-30（MKrPY・i5SN2j・ugP5y）<br>#533 `c9d33d95` 2026-08-30（ugP5y・k5m5Bc）<br>#593 `f9619297` 2026-08-30（i5SN2j） |
...
| | **合計** | **272** | **266** | **268** | **0** | **0** | **0** | **0** | **225** | **37** | **47** | **0** | **0** | **6** | |
...
| 1 | `JN6mQ` | 1-1-2 友だち追加QR | 13.1056% ⚠ | 0px | 下部・右 | docs | [差分画像](dashboard-v6/JN6mQ-diff-1920.png) | **一致** |
| 1 | `NjK9q` | 1-1-3 対応受信の表示件数を開く | 5.0388% | +320px | 中央・右 | docs | [差分画像](dashboard-v6/NjK9q-diff-1920.png) | **一致** |
| 1 | `Alekb` | 1-1-4 通知パネルを開く | 5.0481% | +320px | 下部・右 | docs | [差分画像](dashboard-v6/Alekb-diff-1920.png) | **一致** |
...
| 3 | `IAf7j` | 3-1-C 友だち（一括操作） | 2.5959% | -27px | 中央・右 | docs | [差分画像](friends-v6/IAf7j-diff-1920.png) | **一致** |
...
| 3 | `YzxU1` | 3-2 重複検出 | 5.0356% | -351px | 中央・右 | docs | [差分画像](friends-v6/YzxU1-diff-1920.png) | **一致** |
...
| 5 | `dqFft` | 5-1-G シナリオ・ステップ削除確認 | 9.6790% | 0px | 上部・右 | docs | [差分画像](scenarios-v6/dqFft-diff-1920.png) | **一致** |
...
| 5 | `q5G45` | 5-1-M 一覧の状態（空・読込・エラー） | 4.1226% | 0px | 上部・左 | docs | [差分画像](scenarios-v6/q5G45-diff-1920.png) | **一致** |
...
| 7 | `Y0Sn3` | 7-1-I 削除確認 | 13.7957% ⚠ | 0px | 中央・中央 | docs | [差分画像](reminders-v6/Y0Sn3-diff-1920.png) | **一致** |
...
| 8 | `K7vg2` | 8-1-A 自動応答ルール編集 | 10.9191% ⚠ | +36px | 中央・右 | docs | [差分画像](auto-replies-v6/K7vg2-diff-1920.png) | **一致** |
| 8 | `nzWIX` | 8-1-B 反応条件 | 4.8555% | +131px | 中央・左 | docs | [差分画像](auto-replies-v6/nzWIX-diff-1920.png) | **一致** |
| 8 | `ivDoe` | 8-1-C 応答とアクション | 11.7452% ⚠ | -43px | 中央・右 | docs | [差分画像](auto-replies-v6/ivDoe-diff-1920.png) | **一致** |
...
| 9 | `ec9vg` | 9-1-F 最終確認 | 9.0387% | -56px | 中央・右 | docs | [差分画像](friend-add-v6/ec9vg-diff-1920.png) | **一致** |
| 9 | `quhg6` | 9-1-G 有効化完了 | 3.5706% | 0px | 中央・右 | docs | [差分画像](friend-add-v6/quhg6-diff-1920.png) | **一致** |
...
| 11 | `GFlD7` | 11-1-A メッセージを作る | 7.8623% | -56px | 中央・右 | docs | [差分画像](templates-v6/GFlD7-diff-1920.png) | **一致** |
| 11 | `FRkls` | 11-1-B カルーセルを作る | 6.4648% | 0px | 中央・右 | docs | [差分画像](templates-v6/FRkls-diff-1920.png) | **一致** |
| 11 | `NNDMR` | 11-1-C 質問を作る | 6.8783% | +160px | 上部・右 | docs | [差分画像](templates-v6/NNDMR-diff-1920.png) | **一致** |
| 11 | `j9ixI` | 11-1-D リッチメッセージを作る | 5.4831% | 0px | 中央・右 | docs | [差分画像](templates-v6/j9ixI-diff-1920.png) | **一致** |
| 11 | `hsBtl` | 11-1-E クーポンを作る | 6.2802% | 0px | 中央・右 | docs | [差分画像](templates-v6/hsBtl-diff-1920.png) | **一致** |
| 11 | `J3GxEZ` | 11-1-F リサーチを作る | 6.9543% | +1px | 中央・右 | docs | [差分画像](templates-v6/J3GxEZ-diff-1920.png) | **一致** |
...
| 11 | `NKyoA` | 11-1-I 一覧の状態（空・読込・エラー） | 4.3882% | 0px | 上部・左 | docs | [差分画像](templates-v6/NKyoA-diff-1920.png) | **一致** |
...
| 12 | `DIUbO` | 12-1-C 切替メニューのつながり | 6.6398% | 0px | 上部・右 | docs | [差分画像](rich-menus-v6/DIUbO-diff-1920.png) | **一致** |
| 12 | `NXdDk` | 12-1-C-A つながりなし | 5.5406% | 0px | 上部・右 | docs | [差分画像](rich-menus-v6/NXdDk-diff-1920.png) | **一致** |
...
| 12 | `RW5Tb` | 12-1-G 一覧の状態（空・読込・エラー） | 3.0227% | 0px | 上部・左 | docs | [差分画像](rich-menus-v6/RW5Tb-diff-1920.png) | **一致** |
...
| 15 | `h8pBZr` | 15-1-D 一覧の状態（空・読込・エラー） | 2.2886% | 0px | 中央・中央 | docs | [差分画像](media-v6/h8pBZr-diff-1920.png) | **一致** |
...
| 16 | `njLGA` | 16-1-C 支払い | 3.9877% | 0px | 中央・左 | docs | [差分画像](affiliates-v6/njLGA-diff-1920.png) | **一致** |
| 16 | `xqT1Z` | 16-1-D アフィリエイターを登録する | 5.3374% | 0px | 中央・左 | docs | [差分画像](affiliates-v6/xqT1Z-diff-1920.png) | **一致** |
| 16 | `jwrbf` | 16-1-E アフィリエイターの成果内訳 | 4.9886% | 0px | 中央・右 | docs | [差分画像](affiliates-v6/jwrbf-diff-1920.png) | **一致** |
...
| 17 | `s98Vfw` | 17-1 マイル | 4.5647% | 0px | 中央・左 | docs | [差分画像](mileage-v6/s98Vfw-diff-1920.png) | **一致** |
| 17 | `N46cQ` | 17-1-A たまる決めごと | 5.1058% | +512px | 中央・左 | docs | [差分画像](mileage-v6/N46cQ-diff-1920.png) | **一致** |
| 17 | `qlVLJ` | 17-1-B マイルの使い道 | 4.5295% | 0px | 中央・左 | docs | [差分画像](mileage-v6/qlVLJ-diff-1920.png) | **一致** |
| 17 | `MvZm5` | 17-1-C マイルの履歴 | 4.7272% | +83px | 上部・左 | docs | [差分画像](mileage-v6/MvZm5-diff-1920.png) | **一致** |
| 17 | `BmoGY` | 17-1-D たまる決めごとをつくる | 6.8067% | +895px | 上部・右 | docs | [差分画像](mileage-v6/BmoGY-diff-1920.png) | **一致** |
| 17 | `HIU5O` | 17-1-E 友だちのマイル明細 | 5.4628% | -56px | 中央・右 | docs | [差分画像](mileage-v6/HIU5O-diff-1920.png) | **一致** |
| 17 | `vz0Ji` | 17-1-F マイルを手で増やす・減らす | 20.0423% ⚠ | 0px | 下部・中央 | docs | [差分画像](mileage-v6/vz0Ji-diff-1920.png) | **一致** |
| 17 | `p9CcEB` | 17-1-G マイルの使い道をつくる | 6.2329% | +79px | 上部・右 | docs | [差分画像](mileage-v6/p9CcEB-diff-1920.png) | **一致** |
| 17 | `k8VCU` | 17-1-H たまる決めごと・一覧の状態 | 3.9177% | +512px | 上部・左 | docs | [差分画像](mileage-v6/k8VCU-diff-1920.png) | **一致** |
| 17 | `z3PB2` | 17-2 行動スコア | 4.7051% | 0px | 上部・左 | docs | [差分画像](mileage-v6/z3PB2-diff-1920.png) | **一致** |
...
| 18 | `BMmxU` | 18-1-F 一覧の状態（空・読込・エラー） | 4.5253% | -56px | 中央・左 | docs | [差分画像](inflow-v6/BMmxU-diff-1920.png) | **一致** |
...
| 21 | `VLMGH` | 21-1 NEN配信 | 5.1052% | +239px | 下部・右 | docs | [差分画像](nen-v6/VLMGH-diff-1920.png) | **一致** |
| 21 | `DEX0k` | 21-1-A NENコラム | 4.9252% | +240px | 中央・右 | docs | [差分画像](nen-v6/DEX0k-diff-1920.png) | **一致** |
| 21 | `q4lajm` | 21-1-B ペット・記念日 | 7.5900% | +278px | 中央・右 | docs | [差分画像](nen-v6/q4lajm-diff-1920.png) | **一致** |
| 21 | `WeXbL` | 21-1-C NEN配信の履歴 | 4.9753% | +91px | 中央・左 | docs | [差分画像](nen-v6/WeXbL-diff-1920.png) | **一致** |
| 21 | `HpKyF` | 21-1-D NEN配信の中身を編集する | 5.5549% | +28px | 中央・右 | docs | [差分画像](nen-v6/HpKyF-diff-1920.png) | **一致** |
| 21 | `ymXJK` | 21-1-E コラムを書く | 6.9023% | +236px | 中央・右 | docs | [差分画像](nen-v6/ymXJK-diff-1920.png) | **一致** |
| 21 | `i9sQP` | 21-1-F NENコラム・一覧の状態 | 4.1397% | +240px | 上部・左 | docs | [差分画像](nen-v6/i9sQP-diff-1920.png) | **一致** |
...
| 24 | `festr` | 24-1 LINE通知 | 4.6291% | +38px | 中央・右 | docs | [差分画像](line-notify-v6/festr-diff-1920.png) | **一致** |
| 24 | `Q55bb` | 24-1-A お知らせの中身を編集する | 7.7882% | 0px | 中央・右 | docs | [差分画像](line-notify-v6/Q55bb-diff-1920.png) | **一致** |
| 24 | `X8JCA5` | 24-1-B 送れなかったもの | 4.2100% | 0px | 中央・右 | docs | [差分画像](line-notify-v6/X8JCA5-diff-1920.png) | **一致** |
| 24 | `Se65i` | 24-1-C お知らせの記録 | 3.6791% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/Se65i-diff-1920.png) | **一致** |
| 24 | `DpxOK` | 24-2 運用者へのお知らせ | 4.5965% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/DpxOK-diff-1920.png) | **一致** |
| 24 | `N2gAza` | 24-2-A 運用者へのお知らせをつくる | 4.0175% | +66px | 中央・左 | docs | [差分画像](line-notify-v6/N2gAza-diff-1920.png) | **一致** |
| 25 | `gief7` | 25-1 オートメーション | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `Rv8Jv` | 25-1-A オートメーションをつくる | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `DkPY0` | 25-1-B オートメーションが動いた記録 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `WjYAC` | 25-1-C 見本から作る | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `Vdbv5` | 25-1-D 一覧の状態（空・読込・エラー） | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `xOpDs` | 25-2 共通アクション | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `py5CG` | 25-2-A 共通アクションをつくる | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 25 | `syWp4` | 25-2-B 共通アクションの版と使われている場所 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
...
| 26 | `f8SBSh` | 26-1-C 一覧の状態（空・読込・エラー） | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 27 | `TV2DI` | 27-1 予約管理 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
...
| 27 | `SbuUI` | 27-1-C 今週の予約 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
...
| 28 | `QSLEH` | 28-1 予約設定 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 28 | `tksPc` | 28-1-A 受付枠と休業日 | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 28 | `GhOb3` | 28-1-B 予約メニューをつくる | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 28 | `W6465r` | 28-1-C 一覧の状態（空・読込・エラー） | —（実装画像なし（1920px）） | — | — | — | — | **一致** |
| 29 | `ugP5y` | 29-1 イベント予約 | 4.2259% | 0px | 中央・左 | docs | [差分画像](events-v6/ugP5y-diff-1920.png) | **一致** |
...
| 4 | `dKlkz` | 4-1-F タグ削除の確認ダイアログ | 16.4951% ⚠ | 0px | 中央・右 | docs | [差分画像](friend-attributes-v6/dKlkz-diff-1920.png) | **一致** |
...
| 4 | `HBTk0` | 4-2 友だち情報欄 | 3.4768% | 0px | 中央・中央 | docs | [差分画像](friend-attributes-v6/HBTk0-diff-1920.png) | **一致** |
| 4 | `yKEdO` | 4-2-C 一覧の状態（空・読込・エラー） | 3.2602% | 0px | 上部・左 | docs | [差分画像](friend-attributes-v6/yKEdO-diff-1920.png) | **一致** |
| 4 | `rIhbN` | 4-3 対応マーク | 3.3992% | 0px | 中央・中央 | docs | [差分画像](friend-attributes-v6/rIhbN-diff-1920.png) | **一致** |
| 4 | `QKx8Q` | 4-4 保存した検索 | 3.8077% | 0px | 中央・左 | docs | [差分画像](friend-attributes-v6/QKx8Q-diff-1920.png) | **一致** |
| 4 | `l25rlp` | 4-1-A タグを作る・初期状態 | 4.1692% | +4px | 中央・左 | docs | [差分画像](friend-attributes-v6/l25rlp-diff-1920.png) | **一致** |
| 4 | `tP0RW` | 4-1-B タグを作る・連動ON | 5.1001% | +226px | 中央・左 | docs | [差分画像](friend-attributes-v6/tP0RW-diff-1920.png) | **一致** |
| 4 | `LfrQs` | 4-1-C 連動アクション追加ドロワー | 4.7404% | 0px | 上部・右 | docs | [差分画像](friend-attributes-v6/LfrQs-diff-1920.png) | **一致** |
| 4 | `ee0sk` | 4-1-D タグを編集・既存設定あり | 4.9532% | +242px | 下部・左 | docs | [差分画像](friend-attributes-v6/ee0sk-diff-1920.png) | **一致** |
| 4 | `VjXGX` | 4-1-E 遡及反映の確認ダイアログ | 19.2611% ⚠ | 0px | 下部・中央 | docs | [差分画像](friend-attributes-v6/VjXGX-diff-1920.png) | **一致** |
...
| 4 | `KoT6c` | 4-2-B 友だち情報欄・項目移行 | 3.2107% | +112px | 中央・左 | docs | [差分画像](friend-attributes-v6/KoT6c-diff-1920.png) | **一致** |
| 4 | `GMvBd` | 4-3-A 対応マークを追加・編集 | 2.8098% | 0px | 上部・左 | docs | [差分画像](friend-attributes-v6/GMvBd-diff-1920.png) | **一致** |
| 4 | `zGZMA` | 4-3-B 対応マーク削除の確認ダイアログ | 9.2834% | 0px | 中央・中央 | docs | [差分画像](friend-attributes-v6/zGZMA-diff-1920.png) | **一致** |
| 4 | `XBkiQ` | 4-4-A 保存した検索の条件確認・編集 | 4.6373% | +68px | 中央・左 | docs | [差分画像](friend-attributes-v6/XBkiQ-diff-1920.png) | **一致** |
