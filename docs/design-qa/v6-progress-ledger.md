...
比較済み **269** ／ 比較不可 **3** ／ 注意 **45**。画素差10%超、または高さ差24px超に ⚠ を付けます。

| 機能 | 名前 | 総数 | 比較済み | 一致 | 構造一致・データ未接続 | 要修正 | 未実装 | 未判定 | 画素比較 | 注意 | 比較不可 | 未確認 | 別の仕掛け | 未撮影 | 撮った先 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | ダッシュボード | 5 | 5 | 5 | 0 | 0 | 0 | 0 | 5 | 3 | 0 | 0 | 0 | 0 | #1279 `52d194d19b` 2026-09-07（JN6mQ）<br>#1283 `9548b1061` 2026-09-07（ZN0ov・JN6mQ）<br>#1251 `088cea8a8` 2026-09-07（vUXKb）<br>#419 `c84baa63` 2026-08-30（vUXKb・ZN0ov・JN6mQ・NjK9q・Alekb）<br>#971 `d69099cd9` 2026-09-06（vUXKb・JN6mQ）<br>#1028 `7cc11af48` 2026-09-07（vUXKb・JN6mQ） |
...
| | **合計** | **272** | **253** | **268** | **0** | **0** | **0** | **0** | **269** | **45** | **3** | **0** | **0** | **19** | |
...
| 7 | `W98zZQ` | 7-1-E テスト送信確認 | —（設計画像なし） | — | — | — | — | **一致** |
