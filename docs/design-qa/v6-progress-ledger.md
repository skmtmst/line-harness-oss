...
比較済み **250** ／ 比較不可 **22** ／ 10%超 **50**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| | **合計** | **272** | **266** | **268** | **0** | **0** | **0** | **0** | **250** | **50** | **22** | **0** | **0** | **6** | |
...
| 11 | `M9cij` | 11-1-G テンプレートの削除確認 | 5.3496% | -1px | 上部・左 | [差分画像](templates-v6/M9cij-diff-1920.png) | **一致** |
...
| 16 | `GqFTV` | 16-1-H 支払いを確定する | 8.8713% | -1px | 下部・中央 | [差分画像](affiliates-v6/GqFTV-diff-1920.png) | **一致** |
