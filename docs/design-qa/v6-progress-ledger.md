...
比較済み **272** ／ 比較不可 **0** ／ 注意 **7**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| 27 | 予約管理 | 7 | 7 | 7 | 0 | 0 | 0 | 0 | 7 | 1 | 0 | 0 | 0 | 0 | #0 `e20d921b8` 2026-09-07（TnDbq・GFDqW・GfceK・Lg8ff）<br>#459 `ba0bf62d` 2026-08-29（GFDqW・GfceK・Lg8ff）<br>#562 `45789965` 2026-08-29（Lg8ff）<br>#0 `c275749d` 2026-08-30（TV2DI・TnDbq・SbuUI）<br>#587 `425a6b1a` 2026-08-30（GFDqW・GfceK・Lg8ff） |
...
| | **合計** | **272** | **254** | **268** | **0** | **0** | **0** | **0** | **272** | **7** | **0** | **0** | **0** | **18** | |
...
| 27 | `TV2DI` | 27-1 予約管理 | 4.7640% | +37px ⚠ | 中央・右 | docs | [差分画像](booking-v6/TV2DI-diff-1920.png) | **一致** |
