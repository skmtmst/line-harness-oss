...
比較済み **272** ／ 比較不可 **0** ／ 注意 **6**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| | **合計** | **272** | **262** | **268** | **0** | **0** | **0** | **0** | **272** | **6** | **0** | **0** | **0** | **10** | |
...
| 18 | `IhSBB` | 18-1-A サイトスクリプト | 7.9389% | -56px ⚠ | 中央・中央 | docs | [差分画像](inflow-v6/IhSBB-diff-1920.png) | **一致** |
...
| 23 | `eI3gs` | 23-1 EC連携 | 5.1907% | 0px | 中央・左 | docs | [差分画像](ec-v6/eI3gs-diff-1920.png) | **一致** |
...
| 23 | `oHAN4` | 23-1-C EC連携のつなぎ先 | 4.8238% | +37px ⚠ | 上部・左 | docs | [差分画像](ec-v6/oHAN4-diff-1920.png) | **一致** |
...
| 30 | `e3jz3` | 30-1 ログインユーザー | 4.8731% | 0px | 中央・左 | docs | [差分画像](staff-v6/e3jz3-diff-1920.png) | **一致** |
