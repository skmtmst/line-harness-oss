...
比較済み **272** ／ 比較不可 **0** ／ 注意 **11**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| | **合計** | **272** | **254** | **268** | **0** | **0** | **0** | **0** | **272** | **11** | **0** | **0** | **0** | **18** | |
...
| 7 | `uJP22` | 7-1-A リマインダを作成 | 11.9305% ⚠ | -56px ⚠ | 中央・右 | docs | [差分画像](reminders-v6/uJP22-diff-1920.png) | **一致** |
| 7 | `J64xI` | 7-1-B 通知ステップ編集 | 11.9646% ⚠ | -56px ⚠ | 中央・右 | docs | [差分画像](reminders-v6/J64xI-diff-1920.png) | **一致** |
| 7 | `s7T2dz` | 7-1-C 対象と終了条件 | 4.7497% | -56px ⚠ | 上部・左 | docs | [差分画像](reminders-v6/s7T2dz-diff-1920.png) | **一致** |
| 7 | `JCz6J` | 7-1-D 配信予定プレビュー | 8.2757% | -56px ⚠ | 下部・右 | docs | [差分画像](reminders-v6/JCz6J-diff-1920.png) | **一致** |
| 7 | `W98zZQ` | 7-1-E テスト送信確認 | 9.7008% | 0px | 中央・右 | docs | [差分画像](reminders-v6/W98zZQ-diff-1920.png) | **一致** |
...
| 17 | `MvZm5` | 17-1-C マイルの履歴 | 5.7229% | -56px ⚠ | 中央・左 | docs | [差分画像](mileage-v6/MvZm5-diff-1920.png) | **一致** |
...
| 17 | `p9CcEB` | 17-1-G マイルの使い道をつくる | 6.9933% | -56px ⚠ | 上部・右 | docs | [差分画像](mileage-v6/p9CcEB-diff-1920.png) | **一致** |
