...
比較済み **272** ／ 比較不可 **0** ／ 10%超 **40**。高さは上端を揃えて共通領域を比較し、高さ差を別に記録します。
...
| | **合計** | **272** | **258** | **268** | **0** | **0** | **0** | **0** | **272** | **40** | **0** | **0** | **0** | **14** | |
...
| 9 | `s9gAx` | 9-1-A 基本設定 | 7.1340% | 0px | 下部・右 | docs | [差分画像](friend-add-v6/s9gAx-diff-1920.png) | **一致** |
| 9 | `W1wzCa` | 9-1-B 流入条件 | 6.8937% | 0px | 中央・右 | docs | [差分画像](friend-add-v6/W1wzCa-diff-1920.png) | **一致** |
| 9 | `K0Dbr2` | 9-1-C 初回案内 | 10.3203% ⚠ | 0px | 中央・右 | docs | [差分画像](friend-add-v6/K0Dbr2-diff-1920.png) | **一致** |
...
| 9 | `Q3qP1r` | 9-1-I 削除確認 | 14.2753% ⚠ | 0px | 中央・中央 | docs | [差分画像](friend-add-v6/Q3qP1r-diff-1920.png) | **一致** |
...
| 10 | `LKuAQ` | 10-1-K アーカイブ確認 | 24.3843% ⚠ | 0px | 中央・中央 | docs | [差分画像](webinars-v6/LKuAQ-diff-1920.png) | **一致** |
...
| 16 | `QX70l` | 16-1-G アフィリエイターを削除する確認 | 14.5253% ⚠ | -56px | 下部・中央 | docs | [差分画像](affiliates-v6/QX70l-diff-1920.png) | **一致** |
...
| 17 | `s6MBc` | 17-2-A スコアのルール | 3.0512% | +4px | 上部・右 | docs | [差分画像](mileage-v6/s6MBc-diff-1920.png) | **一致** |
...
| 20 | `URqOA` | 20-1-D 定期レポートをつくる | 4.5751% | +791px | 中央・左 | docs | [差分画像](analytics-v6/URqOA-diff-1920.png) | **一致** |
...
| 22 | `hHrz8` | 22-1-A 写真を1枚ずつ見る | 3.0145% | +476px | 上部・左 | docs | [差分画像](photos-v6/hHrz8-diff-1920.png) | **一致** |
| 22 | `N2J629` | 22-1-B 写真を戻す理由をえらぶ | 11.6056% ⚠ | 0px | 中央・左 | — | [差分画像](photos-v6/N2J629-diff-1920.png) | **一致** |
| 22 | `J3Wxl8` | 22-1-C 出しているもの | 3.5134% | +300px | 中央・中央 | docs | [差分画像](photos-v6/J3Wxl8-diff-1920.png) | **一致** |
...
| 23 | `bfB50` | 23-1-B 定期便 | 4.0296% | 0px | 中央・左 | docs | [差分画像](ec-v6/bfB50-diff-1920.png) | **一致** |
| 23 | `oHAN4` | 23-1-C EC連携のつなぎ先 | 4.4710% | +43px | 下部・左 | docs | [差分画像](ec-v6/oHAN4-diff-1920.png) | **一致** |
...
| 3 | `ux7of` | 3-4-A UID・顧客データ移行／CSV | 4.4334% | 0px | 中央・左 | docs | [差分画像](friends-v6/ux7of-diff-1920.png) | **一致** |
