...
比較済み **272** ／ 比較不可 **0** ／ 注意 **20**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| | **合計** | **272** | **267** | **268** | **0** | **0** | **0** | **0** | **272** | **20** | **0** | **0** | **0** | **5** | |
...
| 10 | `ZC13r` | 10-1 ウェビナー | 3.0507% | 0px | 上部・左 | docs | [差分画像](webinars-v6/ZC13r-diff-1920.png) | **一致** |
...
| 15 | `YfTfJ` | 15-1-C メディアの削除確認 | 8.8648% | 0px | 下部・中央 | docs | [差分画像](media-v6/YfTfJ-diff-1920.png) | **一致** |
...
| 24 | `festr` | 24-1 LINE通知 | 4.7865% | 0px | 中央・左 | docs | [差分画像](line-notify-v6/festr-diff-1920.png) | **一致** |
...
| 32 | `UgonK` | 32-1 運用状態・健全性チェック | 5.1575% | 0px | 中央・左 | docs | [差分画像](operations-v6/UgonK-diff-1920.png) | **一致** |
