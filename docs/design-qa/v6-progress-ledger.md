...
総数 **270** ／ 比較済み **266** ／ 未実装 **0** ／ 未確認 **0** ／ 別の仕掛けで撮影 **4** ／ 未撮影 **0**
...
比較済み **267** ／ 比較不可 **3** ／ 注意 **0**。画素差10%超、または高さ差24px超に ⚠ を付けます。
...
| 21 | NEN配信 | 5 | 5 | 3 | 0 | 0 | 0 | 2 | 3 | 0 | 2 | 0 | 0 | 0 | #1241 `64436d463b` 2026-09-07（VLMGH・WeXbL・ymXJK）<br>#1237 `c6dfe250c` 2026-09-07（HpKyF）<br>#1234 `78c19bea32` 2026-09-07（q4lajm）<br>#1217 `1c8055931` 2026-09-07（VLMGH・DEX0k・q4lajm・WeXbL・ymXJK）<br>#446 `4307088d` 2026-08-28<br>#525 `deff5ffb` 2026-08-29（DEX0k）<br>#526 `dfcc9a53` 2026-08-29（HpKyF）<br>#0 `c275749d` 2026-08-30（VLMGH・q4lajm・WeXbL・i9sQP）<br>#526 `1c91a7bc` 2026-08-30（HpKyF・VLMGH）<br>#620 `ed5c0932` 2026-08-31（ymXJK）<br>#1050 `8d3557ce0` 2026-09-07（VLMGH・DEX0k・q4lajm・WeXbL・ymXJK・i9sQP） |
| 22 | 写真審査 | 4 | 4 | 3 | 0 | 0 | 0 | 1 | 3 | 0 | 1 | 0 | 0 | 0 | #1207 `46a869f74` 2026-09-07（hHrz8・N2J629）<br>#447 `65adbc59` 2026-08-28<br>#0 `c275749d` 2026-08-30（N2J629）<br>#1185 `c992fbd82` 2026-09-07（hHrz8・N2J629） |
...
| | **合計** | **270** | **266** | **263** | **0** | **0** | **0** | **3** | **267** | **0** | **3** | **0** | **4** | **0** | |
...
| 3 | `LT8RS` | 3-1-A 友だち（表示件数を開く） | 4.6414%（前回値） | 0px | 中央・左 | docs | [差分画像](friends-v6/LT8RS-diff-1920.png) | **一致** |
...
| 3 | `InCDe` | 3-2-A 重複候補詳細・統合前確認 | 4.5602%（前回値） | 0px | 中央・左 | docs | [差分画像](friends-v6/InCDe-diff-1920.png) | **一致** |
...
| 5 | `xfYLn` | 5-1-D シナリオ・ステップ編集 | 8.0296% | 0px | 上部・右 | docs | [差分画像](scenarios-v6/xfYLn-diff-1920.png) | **一致** |
...
| 5 | `M2b2B` | 5-1-L シナリオ・配信結果 | 6.0646%（前回値） | 0px | 中央・右 | docs | [差分画像](scenarios-v6/M2b2B-diff-1920.png) | **一致** |
...
| 14 | `gBtaK` | 14-1-A 共通情報を編集 | 5.3987% | 0px | 中央・左 | docs | [差分画像](common-vars-v6/gBtaK-diff-1920.png) | **一致** |
| 14 | `uNBlA` | 14-1-B 変える前に影響を見る | 4.3788% | 0px | 中央・中央 | docs | [差分画像](common-vars-v6/uNBlA-diff-1920.png) | **一致** |
...
| 16 | `jwrbf` | 16-1-E アフィリエイターの成果内訳 | 5.1253%（前回値） | 0px | 中央・右 | docs | [差分画像](affiliates-v6/jwrbf-diff-1920.png) | **一致** |
...
| 19 | `ZrpKn` | 19-1 コンバージョン | 6.5179% | 0px | 下部・右 | docs | [差分画像](conversions-v6/ZrpKn-diff-1920.png) | **一致** |
| 19 | `GUxsj` | 19-1-A コンバージョン レポート | 8.4278% | 0px | 中央・中央 | docs | [差分画像](conversions-v6/GUxsj-diff-1920.png) | **一致** |
| 19 | `GtylA` | 19-1-B 成果地点をつくる | 5.7921% | 0px | 中央・左 | docs | [差分画像](conversions-v6/GtylA-diff-1920.png) | **一致** |
| 19 | `d8d3Mz` | 19-1-C 成果地点の削除確認 | 6.9793% | 0px | 下部・右 | docs | [差分画像](conversions-v6/d8d3Mz-diff-1920.png) | **一致** |
...
| 21 | `z4q1K` | 37-6 NEN配信（自動配信） | —（設計画像なし） | — | — | — | — | **未判定** |
| 21 | `u66A0` | 37-6-A NEN配信（コラム） | —（設計画像なし） | — | — | — | — | **未判定** |
| 21 | `HpKyF` | 21-1-D NEN配信の中身を編集する | 5.7424% | 0px | 中央・右 | docs | [差分画像](nen-v6/HpKyF-diff-1920.png) | **一致** |
| 21 | `ymXJK` | 21-1-E コラムを書く | 6.7930%（前回値） | 0px | 中央・右 | docs | [差分画像](nen-v6/ymXJK-diff-1920.png) | **一致** |
| 21 | `i9sQP` | 21-1-F NENコラム・一覧の状態 | 4.2514%（前回値） | 0px | 上部・左 | docs | [差分画像](nen-v6/i9sQP-diff-1920.png) | **一致** |
| 22 | `cqWo8` | 37-5 然・投稿 | —（設計画像なし） | — | — | — | — | **未判定** |
| 22 | `hHrz8` | 22-1-A 写真を1枚ずつ見る | 3.5042% | 0px | 上部・左 | docs | [差分画像](photos-v6/hHrz8-diff-1920.png) | **一致** |
| 22 | `N2J629` | 22-1-B 写真を戻す理由をえらぶ | 9.9501% | 0px | 下部・中央 | docs | [差分画像](photos-v6/N2J629-diff-1920.png) | **一致** |
| 22 | `J3Wxl8` | 22-1-C 出しているもの | 3.8936% | 0px | 中央・右 | docs | [差分画像](photos-v6/J3Wxl8-diff-1920.png) | **一致** |
| 23 | `eI3gs` | 23-1 EC連携 | 5.0268% | 0px | 中央・左 | docs | [差分画像](ec-v6/eI3gs-diff-1920.png) | **一致** |
| 23 | `ELayY` | 23-1-A 会員のつき合わせ | 3.4714% | 0px | 中央・左 | docs | [差分画像](ec-v6/ELayY-diff-1920.png) | **一致** |
| 23 | `bfB50` | 23-1-B 定期便 | 3.6895% | 0px | 中央・左 | docs | [差分画像](ec-v6/bfB50-diff-1920.png) | **一致** |
...
| 25 | `gief7` | 25-1 オートメーション | 5.0401%（前回値） | 0px | 中央・左 | docs | [差分画像](automations-v6/gief7-diff-1920.png) | **一致** |
| 25 | `Rv8Jv` | 25-1-A オートメーションをつくる | 6.0808% | 0px | 中央・左 | docs | [差分画像](automations-v6/Rv8Jv-diff-1920.png) | **一致** |
| 25 | `DkPY0` | 25-1-B オートメーションが動いた記録 | 5.3198%（前回値） | 0px | 中央・左 | docs | [差分画像](automations-v6/DkPY0-diff-1920.png) | **一致** |
...
| 26 | `k3WxrO` | 26-1 外部連携 | 4.5987% | 0px | 中央・右 | docs | [差分画像](webhooks-v6/k3WxrO-diff-1920.png) | **一致** |
| 26 | `M0Gb7` | 26-1-A こちらで受け取る | 9.9849% | 0px | 下部・中央 | docs | [差分画像](webhooks-v6/M0Gb7-diff-1920.png) | **一致** |
| 26 | `KNG00` | 26-1-B やり取りの記録 | 4.9835% | 0px | 中央・左 | docs | [差分画像](webhooks-v6/KNG00-diff-1920.png) | **一致** |
| 26 | `f8SBSh` | 26-1-C 一覧の状態（空・読込・エラー） | 3.8223%（前回値） | 0px | 中央・中央 | docs | [差分画像](webhooks-v6/f8SBSh-diff-1920.png) | **一致** |
| 27 | `TV2DI` | 27-1 予約管理 | 4.4580% | 0px | 中央・右 | docs | [差分画像](booking-v6/TV2DI-diff-1920.png) | **一致** |
| 27 | `TnDbq` | 27-1-A 予約の詳細 | 5.5075% | 0px | 上部・右 | docs | [差分画像](booking-v6/TnDbq-diff-1920.png) | **一致** |
| 27 | `cpdDi` | 27-1-B 電話の予約を入れる | 6.8063% | 0px | 上部・右 | docs | [差分画像](booking-v6/cpdDi-diff-1920.png) | **一致** |
| 27 | `SbuUI` | 27-1-C 今週の予約 | 4.4369% | 0px | 中央・左 | docs | [差分画像](booking-v6/SbuUI-diff-1920.png) | **一致** |
| 27 | `GFDqW` | 27-1-D 代理予約・内容確認 | 7.7682% | 0px | 上部・右 | docs | [差分画像](booking-v6/GFDqW-diff-1920.png) | **一致** |
| 27 | `GfceK` | 27-1-E 代理予約・登録完了 | 6.9387% | 0px | 中央・右 | docs | [差分画像](booking-v6/GfceK-diff-1920.png) | **一致** |
...
| 32 | `U0BwS` | 32-1-C 緊急停止の最終確認 | 4.8369% | 0px | 中央・中央 | docs | [差分画像](operations-v6/U0BwS-diff-1920.png) | **一致** |
